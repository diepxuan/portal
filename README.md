...
- **[🏗️ Tổng quan kiến trúc](ARCHITECTURE.md)**: Kiến trúc hệ thống, luồng dữ liệu, thành phần cốt lõi
- **[📦 Hệ thống Package](PACKAGES.md)**: 14 package nội bộ trong `diepxuan/` và cách module hoạt động
- **[⚙️ Thiết lập môi trường](DEVELOPMENT.md)**: Hướng dẫn setup development environment
