...
- **[Design System](docs/DESIGN.md)**: DESIGN.md — design tokens (color/typography/radius/spacing/components) chuẩn Google Labs `design.md` spec, dùng cho AI agents và humans
- **[Thiết lập môi trường](docs/DEVELOPMENT.md)**: Hướng dẫn setup development environment
...
│       ├── SIMBA-DOCS.md        # Simba docs mount usage
