...
|-------|------|-------|
| ma_cty | NVARCHAR(10) | Mã công ty |
| stt_rec | NVARCHAR(20) | **FK** - Ref to CaPh3 |
...
| `asPostCaph3_glct` | Post sang GL | pMa_cty, pStt_rec |
...
├── src/Models/
│   ├── CaPh3.php                    # Model extends SModel
│   └── CaCt3.php                    # Model extends SModel
...
│   ├── AsProcessCaPh3.php
│   ├── AsPostCaph3_glct.php
│   ├── AsCAInsPH2.php
│   ├── AsCAUpdPH2.php
│   ├── AsCAInsCT2.php
│   ├── AsCADelCT2.php
│   ├── AsCADelPH2.php              # ⚠️ Cần implement
│   ├── AsGetSoCt.php
│   ├── AsGetSttRec.php
│   ├── AsChkSoCt.php
│   └── AsGetSoDuKh.php
└── database/migrations/
    ├── create_ca_ph3_table.php     # ⚠️ Cần kiểm tra
    └── create_ca_ct3_table.php     # ⚠️ Cần kiểm tra
```
