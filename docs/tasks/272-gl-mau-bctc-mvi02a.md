# Task 272: GLMAUBCTCTMVI02a

## Nhom: GL (So cai tong hop)

## Muc tieu
Chuyen doi module mau bao cao tai chinh I02a tu .NET sang PHP Laravel.

## Chi tiet
- **DLL:** GLMAUBCTCTMVI02a.dll
...
### Bang: BCTCCTMVI02a (Chi tieu mau BCTC I02a)
...
### 1. frmGLMAUBCTCTMVI02a (Form xem danh sach)
- **Ke thua:** frmDMComplexView

### 2. frmGLMAUBCTCTMVI02aEdit (Form them/sua)
...
| SP Name | Mo ta |
|---------|-------|
| SP_GL_BCTC_MVI02A_GET | Lay danh sach chi tieu I02a |
| SP_GL_BCTC_MVI02A_GETBYID | Lay chi tiet 1 chi tieu |
| SP_GL_BCTC_MVI02A_INSERT | Them chi tieu I02a |
| SP_GL_BCTC_MVI02A_UPDATE | Cap nhat chi tieu I02a |
| SP_GL_BCTC_MVI02A_DELETE | Xoa chi tieu I02a |
...
```php
// diepxuan/laravel-simba/src/Models/GL/BCTCCTMVI02a.php
namespace Diepxuan\Simba\Models\GL;

class BCTCCTMVI02a extends Model
{
    protected $table = 'BCTCCTMVI02a';
...
|------|---------|------|---------|
| Model | laravel-simba | BCTCCTMVI02a.php | Chinh |
