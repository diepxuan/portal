...
- **Branch:** chua tao
- **Canonical URL (ky vong):** `/simba/ap/rpt/arrptbccn01103023` (slug sinh theo SimbaMenuRouteMetadata, hau to compact theo task 358)
- **Source route:** chua mo
- **DLL:** ARRptBCCN01.dll (form dung chung cho AR va AP, menuid phan biet)
- **Route name:** `ap.rpt.arrptbccn01103023`
...
| Route | `diepxuan/laravel-catalog/routes/web.php` | `ap.rpt.arrptbccn01103023` -> `Muahang\ApReportIndex` |
...
- [ ] Mo source route `_simba-source/ap/rpt/arrptbccn01103023` trong `diepxuan/laravel-catalog/routes/web.php`
...
- [ ] Browser E2E tren `http://portal.diepxuan.corp/simba/ap/rpt/arrptbccn01103023`
...
- URL `http://portal.diepxuan.corp/simba/ap/rpt/arrptbccn01103023` tra ve report shell theo `SimbaPage` (metadata it nhat: menuid `10.30.23`, report `ARBCCN012.rpt`, command `AsiaErp.UserInterface.frmARRptBCCN01`).
