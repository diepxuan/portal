...
- **Status:** DONE (CA report route shells)
- **Routes:** ca.tienmat.quy, ca.nganhang.quy, ca.thu, ca.chi, ca.rpt.tmnh06, ca.rpt.bk01, ca.rpt.tmnh01a
- **Note:** Các menu CA inactive trong sysMenu chưa mở route execute.
