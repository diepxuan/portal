# Task 270: GLMAUBCTCTMVI

## Nhom: GL (So cai tong hop)

## Muc tieu
Chuyen doi module mau bao cao tai chinh I tu .NET sang PHP Laravel.

## Chi tiet
- **DLL:** GLMAUBCTCTMVI.dll
...
### Bang: BCTCCTMVI (Chi tieu mau BCTC I)
...
### 1. frmGLMAUBCTCTMVI (Form xem danh sach)
- **Ke thua:** frmDMComplexView

### 2. frmGLMAUBCTCTMVIEdit (Form them/sua)
...
| SP Name | Mo ta |
|---------|-------|
| SP_GL_BCTC_MVI_GET | Lay danh sach chi tieu I |
| SP_GL_BCTC_MVI_GETBYID | Lay chi tiet 1 chi tieu |
| SP_GL_BCTC_MVI_INSERT | Them chi tieu I |
| SP_GL_BCTC_MVI_UPDATE | Cap nhat chi tieu I |
| SP_GL_BCTC_MVI_DELETE | Xoa chi tieu I |
...
```php
// diepxuan/laravel-simba/src/Models/GL/BCTCCTMVI.php
namespace Diepxuan\Simba\Models\GL;

class BCTCCTMVI extends Model
{
    protected $table = 'BCTCCTMVI';
...
|------|---------|------|---------|
| Model | laravel-simba | BCTCCTMVI.php | Chinh |
