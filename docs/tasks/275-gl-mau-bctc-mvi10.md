# Task 275: GLMAUBCTCTMVI10

## Nhom: GL (So cai tong hop)

## Muc tieu
Chuyen doi module mau bao cao tai chinh I10 tu .NET sang PHP Laravel.

## Chi tiet
- **DLL:** GLMAUBCTCTMVI10.dll
...
### Bang: BCTCCTMVI10 (Chi tieu mau BCTC I10)
...
### 1. frmGLMAUBCTCTMVI10 (Form xem danh sach)
- **Ke thua:** frmDMComplexView

### 2. frmGLMAUBCTCTMVI10Edit (Form them/sua)
...
| SP Name | Mo ta |
|---------|-------|
| SP_GL_BCTC_MVI10_GET | Lay danh sach chi tieu I10 |
| SP_GL_BCTC_MVI10_GETBYID | Lay chi tiet 1 chi tieu |
| SP_GL_BCTC_MVI10_INSERT | Them chi tieu I10 |
| SP_GL_BCTC_MVI10_UPDATE | Cap nhat chi tieu I10 |
| SP_GL_BCTC_MVI10_DELETE | Xoa chi tieu I10 |
...
```php
// diepxuan/laravel-simba/src/Models/GL/BCTCCTMVI10.php
namespace Diepxuan\Simba\Models\GL;

class BCTCCTMVI10 extends Model
{
    protected $table = 'BCTCCTMVI10';
...
|------|---------|------|---------|
| Model | laravel-simba | BCTCCTMVI10.php | Chinh |
