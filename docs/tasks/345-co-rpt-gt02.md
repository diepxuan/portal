# Task 345: CO - Bao cao Gia thanh 02 (CORptGt02)
...
Bao cao Gia thanh 02 - Bao cao phan tich gia thanh theo SPCT, tong hop chi phi theo tai khoan va san pham. Danh gia gia thanh thuc te. Hien thi ten SPCT day du.

## Form classes

### 1. frmCORptGt02 (Form bao cao)
- **Ke thua:** `frmReport`
- **Chuc nang:** Bao cao Gia thanh 02
- **Controls:**
...
| SP Name | Mo ta |
|---------|-------|
| asCORptGt02 | Lay du lieu bao cao gia thanh 02 |
...
```php
// app/Models/CO/RptGt02.php
namespace Diepxuan\Simba\Models\CO;

class RptGt02 extends Model
{
    protected $table = 'RPT_GT02';
...
```php
// diepxuan/laravel-simba/src/StoredProcedures/AsCORptGt02.php
class AsCORptGt02 extends StoredProcedure
{
    protected $procedure = 'asCORptGt02';
    protected $params = [
...
```php
// diepxuan/laravel-catalog/src/Http/Livewire/CO/BaocaoGt02.php
namespace Diepxuan\Catalog\Http\Livewire\CO;

class BaocaoGt02 extends Component
{
    const MA_CT = 'CO';
    ...
    {
        return view('catalog::co.baocao-gt02');
    }
}
```
...
├── baocao-gt02.blade.php    (Form bao cao)
└── _gt02-result.blade.php   (Ket qua bao cao)
```
...
Route::prefix('catalog/co')
    ->name('catalog.co.')
    ->group(function () {
        Route::get('/baocao-gt02', [BaocaoGt02::class, 'render'])
            ->name('baocao-gt02');
        Route::post('/baocao-gt02/xem', [BaocaoGt02::class, 'xemBaoCao'])
            ->name('baocao-gt02.xem');
    });
```
...
|------|---------|------|---------|
| Model | laravel-simba | RptGt02.php | Bao cao |
| SP | laravel-simba | AsCORptGt02.php | Lay du lieu |
| Component | laravel-catalog | BaocaoGt02.php | Bao cao |
...
- [ ] Tao Stored Procedure class AsCORptGt02
- [ ] Tao Model RptGt02
- [ ] Tao Livewire BaocaoGt02
- [ ] Tao Views
- [ ] Them Routes
