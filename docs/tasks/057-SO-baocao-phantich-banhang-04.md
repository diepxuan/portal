# Task 057: SORptBCPT04

## Nhom: SO (Sales Order - Don hang ban)

## Muc tieu
Chuyen doi chuc nang bao cao phan tich ban hang 04 tu .NET/Crystal Reports sang PHP Laravel, dat ket qua tuong duong Phieubaono.

## Chi tiet
- **DLL:** SORptBCPT04.dll
- **Chuc nang:** Bao cao phan tich ban hang 04 (Doanh so theo bo phan/nhan vien)
- **Loai:** Report (Bao cao)
- **Assembly Title:** Bao cao phan tich ban hang 04
- **Version:** 14.1.0.0
- **Namespace:** `AsiaErp.UserInterface`
- **Company:** Asia Software Development JSC

## Tai lieu tham khao
`/root/.openclaw/workspace/projects/SimbaSql/docs/decompiled/asia/SORptBCPT04.dll/README.md`
...
### frmSORptBCPT04
- **Ke thua:** frmReport
- **Chuc nang:** Hien thi bao cao doanh so ban hang theo bo phan/nhan vien
...
Khi nhan F4 tren dong co ma_vt:
- Menu: SORptF5BCPT04
- Truyen tham so loc + ma_vt tuong ung
...
```php
// diepxuan/laravel-catalog/src/Services/Reports/SoPhanTichBanHang04Report.php
namespace Diepxuan\Catalog\Services\Reports;

class SoPhanTichBanHang04Report
{
    protected array $filters = [];

    // Setter methods (same pattern as BCPT03)
    ...
    {
        return app(SoRptBCPT04::class)->execute($this->filters);
    }
}
```
...
```php
// diepxuan/laravel-simba/src/StoredProcedures/SoRptBCPT04.php
namespace Diepxuan\Simba\StoredProcedures;

class SoRptBCPT04 extends StoredProcedure
{
    protected $procedure = 'SP_SO_RPT_BCPT04';
...
```php
// diepxuan/laravel-catalog/src/Http/Livewire/SO/Reports/PhanTichBanHang04.php
namespace Diepxuan\Catalog\Http\Livewire\SO\Reports;

class PhanTichBanHang04 extends Component
{
    const MA_CT = 'SO';

    // Filter properties (same as BCPT03)
    ...
    {
        $report = app(SoPhanTichBanHang04Report::class)
    ...
    {
        return view('catalog::so.reports.phan-tich-ban-hang-04');
    }
}
```
...
├── phan-tich-ban-hang-04.blade.php
```
...
Route::prefix('catalog/so/reports')
    ...
    ->group(function () {
        Route::get('/phan-tich-ban-hang-04', [PhanTichBanHang04::class, 'render'])
            ->name('phantichbanhang04');
        Route::get('/phan-tich-ban-hang-04/drilldown/{maVt}', [PhanTichBanHang04::class, 'drillDown'])
            ->name('phantichbanhang04.drilldown');
    });
```
...
|------|---------|------|---------|
| SP | laravel-simba | SoRptBCPT04.php | Chinh |
| Report | laravel-catalog | SoPhanTichBanHang04Report.php | Service |
| Component | laravel-catalog | PhanTichBanHang04.php | Viewer |
...
- [ ] Tao Livewire PhanTichBanHang04
- [ ] Tao Views
- [ ] Them Routes
- [ ] Test Drill-down F4
- [ ] Test Export Excel
