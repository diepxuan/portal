...
- **Status:** DONE (read-only shell)
- **Route:** `co.rpt.codmpb` via generic report/list shell
- **Note:** Dictionary metadata PB thiếu/lệch carry fields nên chưa mở CRUD execute.
