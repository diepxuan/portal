...
[DesignerGenerated]
public class frmGlRptBCT05 : frmReport
{
	...
	public override AsDataGridView dgvBC
	{
		[DebuggerNonUserCode]
		get
		{
		...
		set
		{
			...
			DataGridViewCellEventHandler val = new DataGridViewCellEventHandler(CellValidated);
			DataGridViewCellEventHandler val2 = new DataGridViewCellEventHandler(CellEnter);
			if (base.dgvBC != null)
			{
				((DataGridView)base.dgvBC).CellValidated -= val;
				((DataGridView)base.dgvBC).CellEnter -= val2;
			}
			base.dgvBC = value;
			if (base.dgvBC != null)
			{
	...
	public frmGlRptBCT05(string menuid)
		: base(menuid)
	{
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		((Control)this).Name = "frmGlRptBCT05";
	...
	private void CellValidated(object sender, EventArgs e)
	{
		try
		{
			...
			if (Operators.ConditionalCompareObjectNotEqual(dataRowView["ma_so"], (object)"", false) && Operators.CompareString(val.Name, "tien", false) == 0 && Operators.CompareString(array[0][0].ToString(), "", false) != 0)
			{
	...
	private int UpdateDataCell(string maSo, double tien, string stt)
	{
		...
		IGlRptBCT05 glRptBCT = (IGlRptBCT05)DAOFactory.CreateDAOInstance("GlRptBCT05", "GlRptBCT05");
