...
[DesignerGenerated]
public class frmArVchAR4Find : frmVoucherFind
{
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(93, 327);
		((Control)obj).Location = location;
		Button obj2 = cmdOk;
		location = new Point(12, 327);
		((Control)obj2).Location = location;
		GroupBox obj3 = gbPh;
		Size size = new Size(626, 106);
		...
		((Control)this).Name = "frmArVchAR4Find";
