...
internal sealed class MyProject
{
	...
	{
		public frmArVchAR4Find m_frmArVchAR4Find;

		[ThreadStatic]
		private static Hashtable m_FormBeingCreated;

		public frmArVchAR4Find frmArVchAR4Find
		{
			[DebuggerNonUserCode]
			get
			{
				m_frmArVchAR4Find = Create__Instance__<frmArVchAR4Find>(m_frmArVchAR4Find);
				return m_frmArVchAR4Find;
			}
			[DebuggerNonUserCode]
			set
			{
				if (value != m_frmArVchAR4Find)
				{
					if (value != null)
					{
						throw new ArgumentException("Property can only be set to Nothing");
					}
					Dispose__Instance__<frmArVchAR4Find>(ref m_frmArVchAR4Find);
				}
			}
		}
