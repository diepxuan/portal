...
[DesignerGenerated]
public class frmGLMAUBCTCTMV10Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV10Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV10Edit_Load;
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMV10Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
