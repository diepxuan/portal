...
[DesignerGenerated]
public class frmGLMAUBCTCTMV22AEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV22AEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV22AEdit_Load;
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMV22AEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
