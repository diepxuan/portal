...
[DesignerGenerated]
public class frmGLMAUBCTCTMVI02BEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVI02BEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV02Edit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMV02Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
