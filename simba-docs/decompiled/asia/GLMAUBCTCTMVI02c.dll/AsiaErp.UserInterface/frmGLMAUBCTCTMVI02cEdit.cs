...
[DesignerGenerated]
public class frmGLMAUBCTCTMVI02cEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVI02cEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMVI02cEdit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(262, 238);
		...
		TextBox obj4 = txtCong_thuc;
		location = new Point(124, 187);
		((Control)obj4).Location = location;
		((TextBoxBase)txtCong_thuc).MaxLength = 50;
		((Control)txtCong_thuc).Name = "txtCong_thuc";
		TextBox obj5 = txtCong_thuc;
		size = new Size(484, 20);
		((Control)obj5).Size = size;
		((Control)txtCong_thuc).TabIndex = 3;
		TextBox obj6 = txtNd_chtieu;
		location = new Point(124, 73);
		...
		size = new Size(650, 311);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMVI02cEdit";
	...
	private void frmGLMAUBCTCTMVI02cEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
