...
[DesignerGenerated]
public class frmCODMSPCT : frmDMView
{
	...
	public frmCODMSPCT(string menuid)
		: base(menuid)
	{
		__ENCAddToList(this);
		InitializeComponent();
	...
	protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
	{
		...
		if (((int)keyData == 115 || (int)keyData == 114 || (int)keyData == 119) && Operators.CompareString(base.MyMenuInfo.menuid, "16.90.02", false) == 0)
		{
			return false;
		}
