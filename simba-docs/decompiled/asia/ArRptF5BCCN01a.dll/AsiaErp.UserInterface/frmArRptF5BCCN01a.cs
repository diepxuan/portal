...
[DesignerGenerated]
public class frmArRptF5BCCN01a : frmDrilldownReport
{
	...
	public frmArRptF5BCCN01a(ReportInformation motherReportInfo, string drilldownMenuId, AsDictionary formularFields, bool isNT, string nhan_in, string filter4Tilte, string formatedColList, object datasource, params object[] arg)
