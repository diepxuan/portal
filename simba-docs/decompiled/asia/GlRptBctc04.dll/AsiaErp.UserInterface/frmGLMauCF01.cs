...
[DesignerGenerated]
public class frmGLMauCF01 : frmDMView
{
	...
	protected override void InitOtherAfterLoadData()
	{
		...
		base.SourceTable.Columns["Qd_cdkt"].DefaultValue = CompanyInformations.Qd_cdkt;
	...
	{
		base.GetData(CompanyInformations.CompanyID, CompanyInformations.Qd_cdkt, ma_mau);
	}
}
