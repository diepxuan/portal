...
[DesignerGenerated]
public class frmPOVchPO3SeachPO1 : frmAsiaRoot
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPOVchPO3SeachPO1));
		...
		((DataGridViewColumn)dgvcSl_nhap).DataPropertyName = "sl_nhap";
		...
		((Control)this).Name = "frmPOVchPO3SeachPO2";
		((Form)this).ShowInTaskbar = false;
		((Form)this).Text = "Chon PN/DH";
