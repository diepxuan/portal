...
[DesignerGenerated]
public class frmPOVchPO3Find : frmVoucherFind
{
	...
	private void InitializeComponent()
	{
		...
		((Control)lblTen_phi).TabIndex = 233;
		...
		AsTextBox asTextBox12 = txtMa_Phi;
		size = new Size(95, 20);
		...
		((Control)lblTen_Bp).TabIndex = 1279;
