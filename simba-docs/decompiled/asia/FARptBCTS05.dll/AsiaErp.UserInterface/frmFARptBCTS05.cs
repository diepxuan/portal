...
[DesignerGenerated]
public class frmFARptBCTS05 : frmReport
{
	...
	public frmFARptBCTS05(ref string MenuId)
		: base(MenuId)
	{
		lock (__ENCList)
		{
	...
	private void InitializeComponent()
	{
		...
		((Control)lblMa_BPSD).TabIndex = 1330;
		...
		((Control)lblMa_Phi).TabIndex = 1328;
		...
		((Control)lblMa_SPCT).TabIndex = 1326;
		...
		location = new Point(224, 156);
		((Control)obj27).Location = location;
		((Control)lblTen_SPCT).Name = "lblTen_SPCT";
		Label obj28 = lblTen_SPCT;
		size = new Size(318, 13);
		((Control)obj28).Size = size;
		((Control)lblTen_SPCT).TabIndex = 1327;
		SizeF autoScaleDimensions = new SizeF(6f, 13f);
		((ContainerControl)this).AutoScaleDimensions = autoScaleDimensions;
		size = new Size(606, 324);
		((Form)this).ClientSize = size;
		((Control)this).Name = "frmFARptBCTS05";
