...
[DesignerGenerated]
public class frmGLMAUBCTCTMV23Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV23Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV23Edit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(255, 280);
		...
		size = new Size(641, 352);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMV23Edit";
	...
	private void frmGLMAUBCTCTMV23Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
