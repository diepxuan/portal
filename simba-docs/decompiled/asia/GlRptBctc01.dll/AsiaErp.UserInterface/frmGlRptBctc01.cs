...
[DesignerGenerated]
public class frmGlRptBctc01 : frmReport
{
	...
	public frmGlRptBctc01(string menuid)
		: base(menuid)
	{
		sMenuSubTitle = ". F5 - So chu T, Ctrl+F5 - So chi tiet, Shift+F5 - Can doi PS cong no,  F7 - Xem, F9 - In";
		InitializeComponent();
	}
	...
	protected override void InitOtherComponents()
	{
		...
		sMenuSubTitle = AsiaErp.Framework.Environment.getLangSysMessageResX("#GLRPTBCTC01_MENUSUBTITLE").value;
	...
	protected override ArrayList CreateDrilldownArgument(ReportDrillDownInfo drilldownInfo, ref string sDrilldownMenuId, Keys keycode, Keys modifierKeys, ref string filterCondition4title, [Optional][DefaultParameterValue(null)] ref object datasource)
	{
		...
		if ((int)keycode != 116 || Operators.ConditionalCompareObjectEqual(Helper.Repl_Null(RuntimeHelpers.GetObjectValue(dataRowView["tk"]), isNum: false), (object)"", false))
		{
