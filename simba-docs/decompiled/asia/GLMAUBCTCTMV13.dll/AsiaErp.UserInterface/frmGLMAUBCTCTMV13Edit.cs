...
[DesignerGenerated]
public class frmGLMAUBCTCTMV13Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV13Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV13Edit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(261, 196);
		...
		((Control)Label1).TabIndex = 182;
		Label1.Text = "Mã chỉ tiêu";
		Label obj10 = lblTK;
		location = new Point(196, 170);
		((Control)obj10).Location = location;
		((Control)lblTK).Name = "lblTK";
		Label obj11 = lblTK;
		size = new Size(411, 20);
		((Control)obj11).Size = size;
		((Control)lblTK).TabIndex = 181;
		...
		size = new Size(651, 268);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMV13Edit";
	...
	private void frmGLMAUBCTCTMV13Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
