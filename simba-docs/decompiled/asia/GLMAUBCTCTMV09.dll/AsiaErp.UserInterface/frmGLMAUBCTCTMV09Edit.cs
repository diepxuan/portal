...
[DesignerGenerated]
public class frmGLMAUBCTCTMV09Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV09Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV09Edit_Load;
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMV09Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
