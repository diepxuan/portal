...
[DesignerGenerated]
public class frmPOVchPO5SeachPO2PO3PO7 : frmAsiaRoot
{
	...
	public frmPOVchPO5SeachPO2PO3PO7()
	{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPOVchPO5SeachPO2PO3PO7));
		...
		((DataGridView)dgvPh).ColumnHeadersDefaultCellStyle = val;
		...
		((DataGridView)dgvPh).DefaultCellStyle = val2;
		...
		((DataGridView)dgvPh).RowHeadersDefaultCellStyle = val3;
		((DataGridView)dgvPh).RowHeadersWidthSizeMode = (DataGridViewRowHeadersWidthSizeMode)2;
		...
		val5.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcTy_gia).DefaultCellStyle = val5;
		...
		((DataGridView)dgvCt).ColumnHeadersDefaultCellStyle = val6;
		...
		((DataGridView)dgvCt).DefaultCellStyle = val7;
		...
		((DataGridView)dgvCt).RowHeadersDefaultCellStyle = val8;
		((DataGridView)dgvCt).RowHeadersWidthSizeMode = (DataGridViewRowHeadersWidthSizeMode)2;
		...
		val9.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcSo_luong).DefaultCellStyle = val9;
		...
		((DataGridViewColumn)dgvcSl_nhap).DataPropertyName = "sl_px";
		val10.Alignment = (DataGridViewContentAlignment)64;
		val10.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcSl_nhap).DefaultCellStyle = val10;
		((DataGridViewColumn)dgvcSl_nhap).HeaderText = "Đã xuất";
		dgvcSl_nhap.Mask = "### ### ### ###.##";
		...
		val11.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcSl_ton).DefaultCellStyle = val11;
		...
		((Control)this).Name = "frmPOVchPO5SeachPO2PO3PO7";
