...
[DesignerGenerated]
public class frmARPost2TTFind : frmAsiaRoot
{
	...
	private void InitializeComponent()
	{
		...
		((Control)txtDen_ngay).TabIndex = 4;
		...
		((Control)txtTai_khoan).TabIndex = 2;
		...
		((Control)lblTai_khoan).TabIndex = 20;
		...
		((Control)this).Name = "frmARPost2TTFind";
	...
	{
		((TextBox)txtTai_khoan).Text = AsiaErp.Framework.Environment.GetSOConfiguration().tk_pt;
	...
	private void btnNhan_Click(object sender, EventArgs e)
	{
		...
		frmARPost2TTResult frmARPost2TTResult2 = new frmARPost2TTResult();
		...
		dataTable = aRPost2TTDAO.GetDataCT(arrayList.ToArray());
		aRPost2TTDAO.Destroy();
		f_Tk = ((TextBox)txtTai_khoan).Text;
		frmARPost2TTResult2.f_Tk = ((TextBox)txtTai_khoan).Text;
		frmARPost2TTResult2.f_oDt = dataTable;
		frmARPost2TTResult2.f_bIns = f_bIns;
		((Form)frmARPost2TTResult2).ShowDialog();
		f_oRow = frmARPost2TTResult2.f_oRow;
		f_oDtct = frmARPost2TTResult2.f_oDtct;
		((Form)this).Close();
	}
