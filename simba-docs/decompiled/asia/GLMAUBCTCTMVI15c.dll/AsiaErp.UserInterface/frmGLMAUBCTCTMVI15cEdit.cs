...
[DesignerGenerated]
public class frmGLMAUBCTCTMVI15cEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVI15cEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMVVI15cEdit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMVVI15cEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
