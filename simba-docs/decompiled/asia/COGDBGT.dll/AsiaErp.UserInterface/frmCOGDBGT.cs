...
[DesignerGenerated]
public class frmCOGDBGT : frmReport
{
	...
	public frmCOGDBGT(string menuid)
		: base(menuid)
	{
	...
	private void InitializeComponent()
	{
		...
		location = new Point(700, 148);
		((Control)obj3).Location = location;
		((Control)txtNgay2).TabIndex = 2;
		Button obj4 = cmdCancel;
		location = new Point(619, 148);
		...
		size = new Size(564, 225);
		((Form)this).ClientSize = size;
		((Control)this).Name = "frmCOGDBGT";
