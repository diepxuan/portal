# Báo cáo Phân tích DLL: GLMAUBCTCTMVIII.dll
...
| Thuộc tính | Giá trị |
|------------|---------|
| Assembly Name | GLMAUBCTCTMVIII |
| Assembly Title | GLBCTC07VII |
| Assembly Product | GLBCTC07VII |
| Assembly Copyright | Copyright © 2012 |
| Assembly Version | 1.0.0.0 |
| Assembly File Version | 1.0.0.0 |
| GUID | 6508bef1-4826-44d5-b153-a21396623bdc |
| ComVisible | false |
...
```
GLMAUBCTCTMVIII.dll/
├── GLMAUBCTCTMVIII.csproj       # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMVIII.cs    # Main form class
│   └── frmGLMAUBCTCTMVIIIEdit.cs # Edit form
...
|-------|---------|----------|
| `frmGLMAUBCTCTMVIII` | `frmDMComplexView` | Form xem danh sách mẫu báo cáo tài chính III |
| `frmGLMAUBCTCTMVIIIEdit` | `frmDMComplexEdit` | Form chỉnh sửa chỉ tiêu báo cáo tài chính III |
...
**GLMAUBCTCTMVIII.dll là module quản lý mẫu báo cáo tài chính III** trong hệ thống ERP của Asia Software Development JSC.
...
Đây là một module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc cấu hình và quản lý mẫu báo cáo tài chính III - một loại báo cáo tài chính theo quy định của Bộ Tài chính Việt Nam.
