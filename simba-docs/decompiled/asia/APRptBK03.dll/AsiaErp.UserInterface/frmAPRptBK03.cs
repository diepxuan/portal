...
[DesignerGenerated]
public class frmAPRptBK03 : frmReport
{
	...
	[AccessedThroughProperty("lblGiao_dich")]
	private Label _lblGiao_dich;

	[AccessedThroughProperty("cboGiao_dich")]
	private ComboBox _cboGiao_dich;
	...
	internal virtual ComboBox cboChi_xem
	{
		...
		set
		{
			EventHandler eventHandler = cboChi_xem_SelectedIndexChanged;
			EventHandler eventHandler2 = cboChi_xem_GotFocus;
			if (_cboChi_xem != null)
			{
				_cboChi_xem.SelectedIndexChanged -= eventHandler;
				((Control)_cboChi_xem).GotFocus -= eventHandler2;
			}
			_cboChi_xem = value;
			if (_cboChi_xem != null)
			{
	...
	internal virtual Label lblGiao_dich
	{
		[DebuggerNonUserCode]
		get
		{
			return _lblGiao_dich;
		}
		[MethodImpl(MethodImplOptions.Synchronized)]
		[DebuggerNonUserCode]
		set
	...
	internal virtual ComboBox cboGiao_dich
	{
		[DebuggerNonUserCode]
		get
		{
			return _cboGiao_dich;
		}
		[MethodImpl(MethodImplOptions.Synchronized)]
		[DebuggerNonUserCode]
		set
		{
			EventHandler eventHandler = cboGiao_dich_SelectedIndexChanged;
			EventHandler eventHandler2 = cboGiao_dich_GotFocus;
			if (_cboGiao_dich != null)
			{
				_cboGiao_dich.SelectedIndexChanged -= eventHandler;
				((Control)_cboGiao_dich).GotFocus -= eventHandler2;
			}
			_cboGiao_dich = value;
			if (_cboGiao_dich != null)
			{
	...
	public frmAPRptBK03(string MenuId)
		: base(MenuId)
	{
	...
	private void InitializeComponent()
	{
		...
		cboGiao_dich = new ComboBox();
		lblGiao_dich = new Label();
		...
		((Control)tabFilter).Controls.Add((Control)(object)lblGiao_dich);
		((Control)tabFilter).Controls.Add((Control)(object)cboGiao_dich);
		...
		((Control)tabFilter).Controls.SetChildIndex((Control)(object)cboGiao_dich, 0);
		((Control)tabFilter).Controls.SetChildIndex((Control)(object)lblGiao_dich, 0);
		...
		Button obj12 = cmdOk;
		location = new Point(27, 368);
		((Control)obj12).Location = location;
		((Control)cmdOk).TabIndex = 16;
		...
		((Control)txtTieu_De).TabIndex = 19;
		...
		AsTextBox asTextBox4 = txtMa_plkh3;
		...
		Label obj30 = lblTen_plkh1;
		location = new Point(206, 213);
		...
		AsTextBox asTextBox10 = txtMa_NhKh;
		...
		((Control)ChkSap_xep).TabIndex = 11;
		((ButtonBase)ChkSap_xep).Text = "Khách hàng";
		ChkSap_xep.TextValue = "0";
		((ButtonBase)ChkSap_xep).UseVisualStyleBackColor = true;
		SizeF autoScaleDimensions = new SizeF(6f, 13f);
		((ContainerControl)this).AutoScaleDimensions = autoScaleDimensions;
		size = new Size(648, 458);
		((Form)this).ClientSize = size;
		((Control)this).Name = "frmAPRptBK03";
	...
	protected override void InitOtherComponents()
	{
		...
		if (Operators.CompareString(MyMenuInfo.par1, "", false) != 0)
		{
			ArrayList dmMagd = AsiaErp.Framework.Environment.GetDmMagd(MyMenuInfo.par1);
			cboGiao_dich.DataSource = dmMagd;
			((ListControl)cboGiao_dich).DisplayMember = "mo_ta";
			((ListControl)cboGiao_dich).ValueMember = "ma_gd";
		}
		if (cboGiao_dich.Items.Count > 0)
		{
			cboGiao_dich.SelectedIndex = 0;
		}
		cboChi_xem.SelectedIndex = 1;
	...
	protected override bool LoadData()
	{
		...
		arrayList.Add(RuntimeHelpers.GetObjectValue(((ListControl)cboGiao_dich).SelectedValue));
	...
	{
		string text = "";
		if (Operators.CompareString(((MaskedTextBox)txtNgay1).Text.Trim(), "", false) != 0)
		{
			text = text + lblKyBc.Text + ": " + ((MaskedTextBox)txtNgay1).Text.Trim();
		}
		if (Operators.CompareString(((MaskedTextBox)txtNgay2).Text.Trim(), "", false) != 0)
		{
			text = text + lbl2.Text + ((MaskedTextBox)txtNgay2).Text.Trim() + "; ";
		}
		...
		if (cboGiao_dich.SelectedIndex != -1)
		{
			text = text + lblGiao_dich.Text + ": " + cboGiao_dich.SelectedText + "; ";
		}
		...
		if (Operators.CompareString(lblPLKh3.Text.Trim(), "", false) != 0)
		{
			text = text + lblPLKh3.Text + ": " + lblPLKh3.Text + "; ";
		}
		if (Conversions.ToBoolean(ChkSap_xep.Checked))
		{
			text = text + lblSap_xep.Text + ": " + ((ButtonBase)ChkSap_xep).Text + "; ";
		}
		if (cboChi_xem.SelectedIndex != -1)
		{
			text = text + lblChi_xem.Text + ": " + cboChi_xem.Text + "; ";
		}
	...
	private void cboChi_xem_GotFocus(object sender, EventArgs e)
	{
		if (cboChi_xem.SelectedIndex > -1 && (float)cboChi_xem.Text.Length * ((Control)cboChi_xem).Font.Size > (float)((Control)cboChi_xem).Width)
		{
			oToolTip.Show(cboChi_xem.Text, (IWin32Window)(object)cboChi_xem);
		}
		else
		{
			oToolTip.Hide((IWin32Window)(object)cboChi_xem);
		}
	}

	private void cboChi_xem_SelectedIndexChanged(object sender, EventArgs e)
	{
		cboChi_xem_GotFocus(null, null);
	}

	private void cboGiao_dich_GotFocus(object sender, EventArgs e)
	{
		if (cboChi_xem.SelectedIndex > -1 && (float)cboGiao_dich.Text.Length * ((Control)cboGiao_dich).Font.Size > (float)((Control)cboGiao_dich).Width)
		{
			oToolTip.Show(cboGiao_dich.Text, (IWin32Window)(object)cboGiao_dich);
		}
		else
		{
			oToolTip.Hide((IWin32Window)(object)cboGiao_dich);
		}
	}

	private void cboGiao_dich_SelectedIndexChanged(object sender, EventArgs e)
	{
		cboGiao_dich_GotFocus(null, null);
	}
}
