...
[DesignerGenerated]
public class frmCAVchCA1Find : frmVoucherFind
{
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(93, 380);
		...
		Label obj14 = lblTen_Tk_No;
		location = new Point(237, 101);
		((Control)obj14).Location = location;
		((Control)lblTen_Tk_No).Name = "lblTen_Tk_No";
		Label obj15 = lblTen_Tk_No;
		size = new Size(366, 13);
		...
		((Control)lblTk_co).TabIndex = 217;
		lblTk_co.Text = "TK có";
		lblTen_Bp.ImeMode = (ImeMode)0;
		Label obj26 = lblTen_Bp;
		location = new Point(237, 51);
		...
		Label obj34 = lblTen_Hd;
		location = new Point(237, 103);
		...
		Label obj38 = lblTen_Ku;
		location = new Point(462, 405);
		...
		Label obj40 = lblMa_Ku;
		location = new Point(231, 405);
		...
		((Control)this).Name = "frmCAVchCA1Find";
