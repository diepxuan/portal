...
public class frmPORptBK02 : frmReport
{
	...
	private ComboBox _cboTrang_thai;
	...
	internal virtual ComboBox cboTrang_thai
	{
		[DebuggerNonUserCode]
		get
		{
	...
	public frmPORptBK02(string menuID)
		: base(menuID)
	{
		__ENCAddToList(this);
		InitializeComponent();
	...
	private void InitializeComponent()
	{
		...
		//IL_3fb0: Unknown result type (might be due to invalid IL or missing references)
		//IL_3fba: Expected O, but got Unknown
		lblTen_bp = new Label();
		...
		Label obj2 = lbl2;
		Point location = new Point(332, 71);
		((Control)obj2).Location = location;
		((Control)lbl2).TabIndex = 9;
		Button obj3 = cmdExcel;
		location = new Point(668, 605);
		((Control)obj3).Location = location;
		((Control)cmdExcel).TabIndex = 26;
		AsMaskedTextBox asMaskedTextBox = txtNgay2;
		location = new Point(351, 67);
		((Control)asMaskedTextBox).Location = location;
		((Control)txtNgay2).TabIndex = 10;
		Button obj4 = cmdCancel;
		location = new Point(587, 605);
		((Control)obj4).Location = location;
		((Control)cmdCancel).TabIndex = 25;
		Button obj5 = cmdModifyReport;
		location = new Point(510, 17);
		((Control)obj5).Location = location;
		((Control)cmdModifyReport).TabIndex = 2;
		AsMaskedTextBox asMaskedTextBox2 = txtNgay1;
		location = new Point(261, 67);
		((Control)asMaskedTextBox2).Location = location;
		((Control)txtNgay1).TabIndex = 8;
		ComboBox obj6 = cboKyBc;
		location = new Point(165, 67);
		((Control)obj6).Location = location;
		((Control)cboKyBc).TabIndex = 7;
		Label obj7 = lblKyBc;
		location = new Point(25, 71);
		((Control)obj7).Location = location;
		((Control)lblKyBc).TabIndex = 6;
		...
		((Control)lblMau_bc).TabIndex = 0;
		AsTextBox asTextBox = txtMa_Nt;
		location = new Point(165, 476);
		((Control)asTextBox).Location = location;
		((Control)txtMa_Nt).TabIndex = 61;
		Label obj10 = lblMauBC;
		location = new Point(210, 480);
		((Control)obj10).Location = location;
		((Control)lblMauBC).TabIndex = 62;
		RadioButton obj11 = optVND;
		location = new Point(297, 478);
		((Control)obj11).Location = location;
		((Control)optVND).TabIndex = 63;
		RadioButton obj12 = optNt;
		location = new Point(351, 478);
		((Control)obj12).Location = location;
		((Control)optNt).TabIndex = 64;
		Label obj13 = lblMa_nt;
		location = new Point(25, 480);
		((Control)obj13).Location = location;
		((Control)lblMa_nt).TabIndex = 60;
		Button obj14 = cmdOk;
		location = new Point(28, 509);
		((Control)obj14).Location = location;
		((Control)cmdOk).TabIndex = 65;
		Label obj15 = lblTieu_de;
		location = new Point(25, 48);
		((Control)obj15).Location = location;
		((Control)lblTieu_de).TabIndex = 3;
		TextBox obj16 = txtTieu_De;
		location = new Point(165, 44);
		((Control)obj16).Location = location;
		((Control)txtTieu_De).TabIndex = 5;
		lblTen_bp.ImeMode = (ImeMode)0;
		Label obj17 = lblTen_bp;
		location = new Point(582, 733);
		...
		((Control)lblNhom_theo).TabIndex = 19;
		lblNhom_theo.Text = "Nhóm theo";
		cboNhom_theo.DropDownStyle = (ComboBoxStyle)2;
		((ListControl)cboNhom_theo).FormattingEnabled = true;
		cboNhom_theo.Items.AddRange(new object[10] { "Nhà cung cấp", "Bộ phận ", "Hợp đồng", "Hình thức thanh toán", "Vật tư", "Kho", "Lô", "Phí", "Chứng từ", "Sản phẩm công trình" });
		...
		((Control)cboNhom_theo).TabIndex = 20;
		...
		((Control)cboLoaiPhieu).TabIndex = 16;
		...
		cboTrang_thai.DropDownStyle = (ComboBoxStyle)2;
		((Control)cboTrang_thai).Enabled = false;
		((ListControl)cboTrang_thai).FormattingEnabled = true;
		cboTrang_thai.Items.AddRange(new object[1] { "Tất cả" });
		ComboBox obj33 = cboTrang_thai;
		location = new Point(419, 115);
		((Control)obj33).Location = location;
		((Control)cboTrang_thai).Name = "cboTrang_thai";
		ComboBox obj34 = cboTrang_thai;
		size = new Size(166, 21);
		((Control)obj34).Size = size;
		((Control)cboTrang_thai).TabIndex = 18;
		...
		Label obj37 = lblTen_TT;
		location = new Point(744, 451);
		((Control)obj37).Location = location;
		((Control)lblTen_TT).Name = "lblTen_TT";
		Label obj38 = lblTen_TT;
		size = new Size(335, 13);
		...
		((Control)lblTen_HTTT).Anchor = (AnchorStyles)13;
		Label obj41 = lblTen_HTTT;
		location = new Point(261, 312);
		((Control)obj41).Location = location;
		((Control)lblTen_HTTT).Name = "lblTen_HTTT";
		Label obj42 = lblTen_HTTT;
		size = new Size(702, 13);
		((Control)obj42).Size = size;
		((Control)lblTen_HTTT).TabIndex = 41;
		...
		((Control)txtMA_HTTT).TabIndex = 40;
		...
		Label obj51 = lblMa_vitri;
		location = new Point(549, 471);
		((Control)obj51).Location = location;
		((Control)lblMa_vitri).Name = "lblMa_vitri";
		Label obj52 = lblMa_vitri;
		size = new Size(46, 13);
		...
		((Control)txtMa_nhhd).TabIndex = 37;
		...
		((Control)lblTen_kho).TabIndex = 44;
		...
		Label obj71 = lblTen_kh;
		location = new Point(261, 168);
		((Control)obj71).Location = location;
		((Control)lblTen_kh).Name = "lblTen_kh";
		Label obj72 = lblTen_kh;
		size = new Size(702, 13);
		((Control)obj72).Size = size;
		((Control)lblTen_kh).TabIndex = 23;
		...
		Label obj77 = lblMa_nh_ncc;
		location = new Point(549, 498);
		...
		((Control)txtPl_ncc1).TabIndex = 25;
		txtPl_ncc1.UseAutoCompleteSource = true;
		((Control)lblTen_pl_kh1).Anchor = (AnchorStyles)13;
		lblTen_pl_kh1.ImeMode = (ImeMode)0;
		Label obj83 = lblTen_pl_kh1;
		location = new Point(261, 192);
		((Control)obj83).Location = location;
		((Control)lblTen_pl_kh1).Name = "lblTen_pl_kh1";
		Label obj84 = lblTen_pl_kh1;
		size = new Size(702, 13);
		((Control)obj84).Size = size;
		((Control)lblTen_pl_kh1).TabIndex = 26;
		...
		Label obj99 = lblTen_plvt1;
		location = new Point(833, 127);
		((Control)obj99).Location = location;
		((Control)lblTen_plvt1).Name = "lblTen_plvt1";
		Label obj100 = lblTen_plvt1;
		...
		Label obj107 = lblPlvt2;
		location = new Point(609, 142);
		((Control)obj107).Location = location;
		((Control)lblPlvt2).Name = "lblPlvt2";
		Label obj108 = lblPlvt2;
		size = new Size(56, 13);
		...
		Label obj111 = lblPlvt1;
		location = new Point(609, 119);
		((Control)obj111).Location = location;
		((Control)lblPlvt1).Name = "lblPlvt1";
		Label obj112 = lblPlvt1;
		size = new Size(56, 13);
	...
	protected override void InitOtherComponents()
	{
		...
		arrayList3.Add(dictionaryEntry);
		dictionaryEntry = new DictionaryEntry("MA_KHO", RuntimeHelpers.GetObjectValue(val.Items[5]));
		arrayList3.Add(dictionaryEntry);
		dictionaryEntry = new DictionaryEntry("MA_LO", RuntimeHelpers.GetObjectValue(val.Items[6]));
		arrayList3.Add(dictionaryEntry);
		dictionaryEntry = new DictionaryEntry("MA_PHI", RuntimeHelpers.GetObjectValue(val.Items[7]));
		arrayList3.Add(dictionaryEntry);
		dictionaryEntry = new DictionaryEntry("STT_REC", RuntimeHelpers.GetObjectValue(val.Items[8]));
		arrayList3.Add(dictionaryEntry);
		dictionaryEntry = new DictionaryEntry("MA_SPCT", RuntimeHelpers.GetObjectValue(val.Items[9]));
		arrayList3.Add(dictionaryEntry);
		val.Items.Clear();
		val.DataSource = arrayList3;
	...
	private string GetFilterTitle()
	{
		...
		{
			text = text + lblTen_vitri.Text + ": [" + ((TextBox)txtMa_vtri).Text + " - " + lblTen_vitri.Text + "]; ";
		}
		...
		{
			text = text + lblHTTT.Text + ": [" + ((TextBox)txtMA_HTTT).Text + " - " + lblTen_HTTT.Text + "]; ";
		}
		if (Operators.CompareString(((TextBox)txtMA_DKTT).Text.Trim(), "", false) != 0)
		{
			text = text + lblDkTT.Text + ": [" + ((TextBox)txtMA_DKTT).Text + " - " + lblTen_TT.Text + "]; ";
		}
		...
		{
			text = text + lblTenPhi.Text + ": [" + ((TextBox)txtMaPhi).Text + " - " + lblTenPhi.Text + "]; ";
		}
		...
		{
			text = text + lblMa_ncc.Text + ": [" + ((TextBox)txtMa_ncc).Text + " - " + lblTen_kh.Text + "]; ";
		}
		if (Operators.CompareString(((TextBox)txtMa_nh_ncc).Text, "", false) != 0)
		{
			text = text + lblMa_nh_ncc.Text + ": [" + ((TextBox)txtMa_nh_ncc).Text + " - " + lblTen_nh_kh.Text + "]; ";
		}
		if (Operators.CompareString(((TextBox)txtPl_ncc1).Text, "", false) != 0)
		{
			text = text + lblPl_ncc1.Text + ": [" + ((TextBox)txtPl_ncc1).Text + " - " + lblTen_pl_kh1.Text + "]; ";
		}
		if (Operators.CompareString(((TextBox)txtPl_ncc2).Text, "", false) != 0)
		{
			text = text + lblPl_ncc2.Text + ": [" + ((TextBox)txtPl_ncc2).Text + " - " + lblTen_pl_kh2.Text + "]; ";
		}
		if (Operators.CompareString(((TextBox)txtPl_ncc3).Text, "", false) != 0)
		{
			text = text + lblPl_ncc3.Text + ": [" + ((TextBox)txtPl_ncc3).Text + " - " + lblTen_pl_kh3.Text + "]; ";
		}
		...
		text = text + lblTrang_thai.Text + ": [" + cboTrang_thai.Text + "]; ";
