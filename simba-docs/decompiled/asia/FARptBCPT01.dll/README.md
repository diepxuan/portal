# Báo cáo Phân tích DLL: FARptBCPT01.dll
...
| GUID | eec14814-b39b-4667-9d7e-580df47fa947 |
| ComVisible | false |
...
```
FARptBCPT01.dll/
├── FARptBCPT01.csproj           # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   └── frmFARptBCPT01.cs        # Main report form
...
|-------|---------|----------|
| `frmFARptBCPT01` | `frmReport` | Form báo cáo phân tích tài sản 01 |
...
**FARptBCPT01.dll là module báo cáo phân tích tài sản 01** trong hệ thống ERP của Asia Software Development JSC.
...
Đây là module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc xem và xuất báo cáo phân tích tài sản cố định theo nhiều tiêu chí phân loại khác nhau.
