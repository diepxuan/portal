...
public class MsSqlCA4SODAO : MsSqlDAO
{
	[DebuggerNonUserCode]
	public MsSqlCA4SODAO()
	{
	}

	public bool SOSaveCAPH4SO(ref string aStt_rec, string pMa_ct, string pStt_rec_hd, DateTime pNgay_ct, string pSo_ct, string pMa_kh, string pDia_chi, string pNguoi_gd, string pDien_giai, string pMa_nt, decimal pTy_gia, decimal pT_tien_nt, decimal pT_tien, string pTk_no, string pUser)
	{
		_command.CommandType = CommandType.StoredProcedure;
		_command.CommandText = "asSOSaveCAPH4SO";
		...
		_command.Parameters.AddWithValue("@pTk_no", (object)pTk_no);
	...
	public object SOSaveCACT4SO(DataRow oDr)
	{
		_command.CommandType = CommandType.StoredProcedure;
		_command.CommandText = "asSOSaveCACT4SO";
		_command.Parameters.Clear();
