...
[DesignerGenerated]
public class frmGLMAUBCTCTMIXEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMIXEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMIXEdit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMIXEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
