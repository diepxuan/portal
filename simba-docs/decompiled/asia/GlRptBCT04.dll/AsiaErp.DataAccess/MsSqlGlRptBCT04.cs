...
public class MsSqlGlRptBCT04 : MsSqlDAO, IGlRptBCT04
{
	[DebuggerNonUserCode]
	public MsSqlGlRptBCT04()
	{
	}
	...
	public object UpdateDataCell(string ma_cty, DateTime ngay1, DateTime ngay2, string mau, string maSo, double tien, string stt)
	{
		...
		_command.CommandText = "asRptUpdTATNDN01A_DC";
	...
	object IGlRptBCT04.UpdateDataCell(string ma_cty, DateTime ngay1, DateTime ngay2, string mau, string maSo, double tien, string stt)
	{
