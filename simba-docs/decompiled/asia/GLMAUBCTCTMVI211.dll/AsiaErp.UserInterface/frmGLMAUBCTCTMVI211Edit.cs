...
[DesignerGenerated]
public class frmGLMAUBCTCTMVI211Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVI211Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMVI211Edit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMVI211Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
