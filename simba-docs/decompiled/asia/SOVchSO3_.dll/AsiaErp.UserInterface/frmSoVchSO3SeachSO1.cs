...
[DesignerGenerated]
public class frmSoVchSO3SeachSO1 : frmAsiaRoot
{
	...
	private void InitializeComponent()
	{
		...
		((DataGridViewColumn)dgvcSl_xuat).DataPropertyName = "sl_hd";
		val6.Alignment = (DataGridViewContentAlignment)64;
		val6.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcSl_xuat).DefaultCellStyle = val6;
		((DataGridViewColumn)dgvcSl_xuat).HeaderText = "Đã lập";
		dgvcSl_xuat.Mask = "### ### ### ###.##";
		...
		((Control)cmdChon).Anchor = (AnchorStyles)10;
		...
		((Control)this).Name = "frmSoVchSo3SeachSo1";
