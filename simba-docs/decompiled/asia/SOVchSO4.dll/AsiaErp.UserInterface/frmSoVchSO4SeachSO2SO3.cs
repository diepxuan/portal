...
[DesignerGenerated]
public class frmSoVchSO4SeachSO2SO3 : frmAsiaRoot
{
	...
	[AccessedThroughProperty("dgvcSl_xuat")]
	private DataGridViewAsTextNumericColumn _dgvcSl_xuat;
	...
	private DataGridViewTextBoxColumn _dgvcMa_Nvkd;
	...
	internal virtual DataGridViewAsTextNumericColumn dgvcSl_xuat
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual DataGridViewTextBoxColumn dgvcMa_Nvkd
	{
		[DebuggerNonUserCode]
		get
		{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmSoVchSO4SeachSO2SO3));
		...
		dgvcSl_xuat = new DataGridViewAsTextNumericColumn();
		...
		dgvcMa_Nvkd = new DataGridViewTextBoxColumn();
		...
		((DataGridViewColumn)dgvcNgay_ct).Width = 70;
		...
		((DataGridViewColumn)dgvcMa_kh).HeaderText = "Mã khách";
		...
		((DataGridView)dgvCt).Columns.AddRange((DataGridViewColumn[])(object)new DataGridViewColumn[12]
		{
			...
			(DataGridViewColumn)dgvcMa_Nvkd
		});
		...
		((DataGridViewColumn)dgvcSl_xuat).DataPropertyName = "sl_nhap";
		val6.Alignment = (DataGridViewContentAlignment)64;
		val6.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcSl_xuat).DefaultCellStyle = val6;
		((DataGridViewColumn)dgvcSl_xuat).HeaderText = "Đã nhập";
		dgvcSl_xuat.Mask = "### ### ### ###.##";
		((DataGridViewColumn)dgvcSl_xuat).Name = "dgvcSl_xuat";
		((DataGridViewColumn)dgvcSl_xuat).ReadOnly = true;
		dgvcSl_xuat.SortMode = (DataGridViewColumnSortMode)0;
		dgvcSl_xuat.SpecialType = Commons.NumericSpecialType.Quantity;
		((DataGridViewColumn)dgvcSl_xuat).Width = 70;
		((DataGridViewColumn)dgvcSl_ton).DataPropertyName = "ton";
		...
		((DataGridViewColumn)dgvcMa_bp).ReadOnly = true;
		...
		((DataGridViewColumn)dgvcMa_Nvkd).ReadOnly = true;
		...
		((Control)this).Name = "frmSoVchSO4SeachSO2SO3";
		((Form)this).ShowInTaskbar = false;
		((Form)this).Text = "Chon PX/HD";
