...
[DesignerGenerated]
public class frmSoVchSo4FindSO2 : frmAsiaRoot
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmSoVchSo4FindSO2));
		...
		Point location = new Point(91, 194);
		...
		GroupBox obj22 = gbCt;
		size = new Size(547, 185);
		((Control)obj22).Size = size;
		((Control)gbCt).TabIndex = 0;
		gbCt.TabStop = false;
		lblTen_Kh.ImeMode = (ImeMode)0;
		Label obj23 = lblTen_Kh;
		location = new Point(201, 73);
		((Control)obj23).Location = location;
		((Control)lblTen_Kh).Name = "lblTen_Kh";
		Label obj24 = lblTen_Kh;
		size = new Size(320, 13);
		((Control)obj24).Size = size;
		((Control)lblTen_Kh).TabIndex = 270;
		...
		((Control)this).Name = "frmSoVchSo4FindSO2";
		((Form)this).Text = "Loc Phieu Xuat";
