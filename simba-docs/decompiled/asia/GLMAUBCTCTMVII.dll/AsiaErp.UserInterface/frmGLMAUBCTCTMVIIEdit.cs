...
[DesignerGenerated]
public class frmGLMAUBCTCTMVIIEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVIIEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMVVIIEdit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(257, 274);
		...
		size = new Size(645, 345);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMVIEdit";
	...
	private void frmGLMAUBCTCTMVVIIEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
