...
[DesignerGenerated]
public class frmGlRptF5Bctc03 : frmDrilldownReport
{
	...
	private void InitializeComponent()
	{
		...
		Size clientSize = new Size(792, 512);
		((Form)this).ClientSize = clientSize;
		((Control)this).Name = "frmGlRptF5Bctc03";
	...
	public frmGlRptF5Bctc03(ReportInformation motherReportInfo, string drilldownMenuId, AsDictionary formularFields, bool isNT, string nhan_in, string filter4Tilte, string formatedColList, object datasource, params object[] arg)
		: base(motherReportInfo, drilldownMenuId, formularFields, isNT, nhan_in, filter4Tilte, formatedColList, RuntimeHelpers.GetObjectValue(datasource), arg)
	{
		...
		((Control)this).KeyDown += new KeyEventHandler(frmGlRptF5Bctc03_KeyDown);
		InitializeComponent();
	}
	...
	private void frmGlRptF5Bctc03_KeyDown(object sender, KeyEventArgs e)
	{
