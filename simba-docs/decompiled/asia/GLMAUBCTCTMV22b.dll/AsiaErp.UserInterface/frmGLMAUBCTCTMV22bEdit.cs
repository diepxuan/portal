...
[DesignerGenerated]
public class frmGLMAUBCTCTMV22bEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV22bEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV22BEdit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(258, 318);
	...
	private void frmGLMAUBCTCTMV22BEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
