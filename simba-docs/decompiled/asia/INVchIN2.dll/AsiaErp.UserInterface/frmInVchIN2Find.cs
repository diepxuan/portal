...
[DesignerGenerated]
public class frmInVchIN2Find : frmVoucherFind
{
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(93, 481);
		...
		AsTextBox asTextBox19 = txtTk_vt;
		location = new Point(153, 97);
		...
		AsTextBox asTextBox20 = txtTk_vt;
		size = new Size(95, 20);
		...
		size = new Size(735, 516);
		((Form)this).ClientSize = size;
		((Control)this).Name = "frmInVchIN2Find";
