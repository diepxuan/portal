...
[DesignerGenerated]
public class frmGLMauCF01Edit : frmDMEdit
{
	...
	[AccessedThroughProperty("lblTkconlai")]
	private Label _lblTkconlai;

	[AccessedThroughProperty("cboLoaiPS")]
	private AsComboBox _cboLoaiPS;
	...
	internal virtual AsCheckBox chkCach_tinh
	{
		...
		set
		{
			EventHandler eventHandler = chkCach_tinh_Validated;
			EventHandler eventHandler2 = chkCach_tinh_Click;
			if (_chkCach_tinh != null)
			{
				((Control)_chkCach_tinh).Validated -= eventHandler;
				((Control)_chkCach_tinh).Click -= eventHandler2;
			}
			_chkCach_tinh = value;
			if (_chkCach_tinh != null)
			{
	...
	internal virtual Label lblTkconlai
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual AsComboBox cboLoaiPS
	{
		[DebuggerNonUserCode]
		get
		{
	...
	private void InitializeComponent()
	{
		...
		Label7 = new Label();
		cboLoaiPS = new AsComboBox();
		lblTkconlai = new Label();
		...
		((Control)gbLine).Controls.Add((Control)(object)lblTkconlai);
		...
		((Control)gbLine).Controls.SetChildIndex((Control)(object)lblTkconlai, 0);
		...
		((Control)chkCach_tinh).TabIndex = 7;
		...
		Label4.Text = "- DSTK nợ";
		TextBox obj12 = txtCach_tinh;
		location = new Point(101, 306);
		((Control)obj12).Location = location;
		((Control)txtCach_tinh).Name = "txtCach_tinh";
		TextBox obj13 = txtCach_tinh;
		size = new Size(439, 20);
		((Control)obj13).Size = size;
		((Control)txtCach_tinh).TabIndex = 11;
		...
		((Control)Label7).TabIndex = 152;
		Label7.Text = "- Loại chỉ tiêu";
		((ComboBox)cboLoaiPS).DropDownStyle = (ComboBoxStyle)2;
		((ListControl)cboLoaiPS).FormattingEnabled = true;
		AsComboBox asComboBox = cboLoaiPS;
		location = new Point(101, 275);
		((Control)asComboBox).Location = location;
		((Control)cboLoaiPS).Name = "cboLoaiPS";
		AsComboBox asComboBox2 = cboLoaiPS;
		size = new Size(100, 21);
		((Control)asComboBox2).Size = size;
		((Control)cboLoaiPS).TabIndex = 10;
		lblTkconlai.AutoSize = true;
		Label obj14 = lblTkconlai;
		location = new Point(279, 225);
		((Control)obj14).Location = location;
		((Control)lblTkconlai).Name = "lblTkconlai";
		Label obj15 = lblTkconlai;
		size = new Size(129, 13);
		((Control)obj15).Size = size;
		((Control)lblTkconlai).TabIndex = 154;
		lblTkconlai.Text = "(# - Các tài khoản còn lại)";
		SizeF autoScaleDimensions = new SizeF(6f, 13f);
		((ContainerControl)this).AutoScaleDimensions = autoScaleDimensions;
		size = new Size(582, 409);
		((Form)this).ClientSize = size;
		((Form)this).MaximizeBox = false;
		((Form)this).MinimizeBox = false;
		((Control)this).Name = "frmGLMauCF01Edit";
	...
	{
		RowToEdit["ten_ps"] = ((ComboBox)cboLoaiPS).Text;
	...
	protected override void InitBeforeGetData()
	{
		...
		dataTable.Rows.Add("1", "1. Thu");
		dataTable.Rows.Add("2", "2. Chi");
		dataTable.Rows.Add("3", "3. Dư đầu");
		dataTable.Rows.Add("4", "4. Dư cuối");
	...
	protected override void InitAfterGetData()
	{
		...
		if ((Operators.CompareString(((TextBox)txtDsTK_no).Text.Trim(), "", false) == 0 && Operators.CompareString(((TextBox)txtDsTk_co).Text.Trim(), "", false) == 0 && Operators.CompareString(txtCach_tinh.Text.Trim(), "", false) != 0) ? true : false)
		{
			((CheckBox)chkCach_tinh).CheckState = (CheckState)0;
		}
		if ((Operators.CompareString(txtCach_tinh.Text.Trim(), "", false) == 0 && (Operators.CompareString(((TextBox)txtDsTK_no).Text.Trim(), "", false) != 0 || Operators.CompareString(((TextBox)txtDsTk_co).Text.Trim(), "", false) != 0)) ? true : false)
		{
			((CheckBox)chkCach_tinh).CheckState = (CheckState)1;
		}
	...
	protected override void DataBinding()
	{
		...
		cboLoaiPS = (AsComboBox)(object)ojb;
	}
	...
	protected override bool ValidData()
	{
		...
		if ((int)checkState == 1)
		{
			int num = ((TextBox)txtDsTk_co).Text.Split(new char[1] { ',' }).Length;
			if (Operators.ConditionalCompareObjectNotEqual((object)num, Commons.GetDataTable("asGLGetDmTk", CompanyInformations.CompanyID).Compute("count(tk)", "tk in ('" + ((TextBox)txtDsTk_co).Text.Trim().Replace(",", "','") + "')"), false))
			{
				SetControlError((Control)(object)txtDsTk_co, MySettingsProperty.Settings.MSG_DS_TK);
				((Control)txtDsTk_co).Select();
				return true;
			}
			num = ((TextBox)txtDsTK_no).Text.Split(new char[1] { ',' }).Length;
			if (Conversions.ToBoolean((!Conversions.ToBoolean(chkCach_tinh.Checked) || !Conversions.ToBoolean((object)Operators.ConditionalCompareObjectNotEqual((object)num, Commons.GetDataTable("asGLGetDmTk", CompanyInformations.CompanyID).Compute("count(tk)", "tk in ('" + ((TextBox)txtDsTK_no).Text.Trim().Replace(",", "','") + "')"), false))) ? ((object)false) : ((object)true)))
			{
				SetControlError((Control)(object)txtDsTK_no, MySettingsProperty.Settings.MSG_DS_TK);
				((Control)txtDsTK_no).Select();
				return true;
			}
			return (Commons.ChkEmtyTextBoxAndShowMessageBox((TextBox)(object)txtDsTK_no) && Commons.ChkEmtyTextBoxAndShowMessageBox((TextBox)(object)txtDsTk_co) && base.ValidData()) ? true : false;
		}
	...
	private void chkCach_tinh_Click(object sender, EventArgs e)
	{
		...
		if ((int)checkState == 1)
		{
			...
			((Control)lblTkconlai).Visible = true;
		}
		else
		{
			...
			((Control)lblTkconlai).Visible = false;
		}
	}
