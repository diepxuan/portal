...
[DesignerGenerated]
public class frmSIDMOpt10 : frmDMView
{
	private IContainer components;

	public frmSIDMOpt10(string menuid)
		: base(menuid)
	{
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(314, 397);
		...
		Size clientSize = new Size(741, 427);
		((Form)this).ClientSize = clientSize;
		((Control)this).Name = "frmSIDMOpt10";
