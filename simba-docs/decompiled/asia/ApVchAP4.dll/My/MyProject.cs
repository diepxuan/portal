...
internal sealed class MyProject
{
	...
	{
		public frmApVchAP4Find m_frmApVchAP4Find;

		[ThreadStatic]
		private static Hashtable m_FormBeingCreated;

		public frmApVchAP4Find frmApVchAP4Find
		{
			[DebuggerNonUserCode]
			get
			{
				m_frmApVchAP4Find = Create__Instance__<frmApVchAP4Find>(m_frmApVchAP4Find);
				return m_frmApVchAP4Find;
			}
			[DebuggerNonUserCode]
			set
			{
				if (value != m_frmApVchAP4Find)
				{
					if (value != null)
					{
						throw new ArgumentException("Property can only be set to Nothing");
					}
					Dispose__Instance__<frmApVchAP4Find>(ref m_frmApVchAP4Find);
				}
			}
		}
