...
public class MsSqlAPPost2TTDAO : MsSqlDAO, APPost2TTDAO
{
	[DebuggerNonUserCode]
	public MsSqlAPPost2TTDAO()
	{
	}
	...
	public DataTable GetData()
	{
		...
		_command.CommandText = "asAPGetMaCT";
	...
	{
		_command.CommandType = CommandType.StoredProcedure;
		_command.CommandText = "asAPGetPost2TT_APTT";
		_command.Parameters.Clear();
		_command.Parameters.AddWithValue("@pMa_cty", (object)CompanyInformations.CompanyID);
	...
	DataTable APPost2TTDAO.GetData(string Tk, string Ma_kh, DateTime Ngay_ct, string Loai, string stt_rec = null)
	{
		//ILSpy generated this explicit interface implementation from .override directive in GetData
	...
	{
		_command.CommandType = CommandType.StoredProcedure;
		_command.CommandText = "asAPGetPost2TT";
		_command.Parameters.Clear();
		_command.Parameters.AddWithValue("@pMa_cty", (object)CompanyInformations.CompanyID);
	...
	DataTable APPost2TTDAO.GetDataCT(params object[] array)
	{
	...
	public int Insert(params object[] array)
	{
		...
		_command.CommandText = "asAPInsPost2TT_APTT";
		_command.CommandType = CommandType.StoredProcedure;
		_command.Parameters.Clear();
		_command.Parameters.AddWithValue("@pMa_cty", (object)CompanyInformations.CompanyID);
	...
	int APPost2TTDAO.Insert(params object[] array)
	{
	...
	public int Delete(params object[] array)
	{
		...
		_command.CommandText = "asAPDelPost2TT_APTT";
		_command.CommandType = CommandType.StoredProcedure;
		_command.Parameters.Clear();
		_command.Parameters.AddWithValue("@pMa_cty", (object)CompanyInformations.CompanyID);
		_command.Parameters.AddWithValue("@pStt_rec", RuntimeHelpers.GetObjectValue(array[0]));
	...
	int APPost2TTDAO.Delete(params object[] array)
	{
