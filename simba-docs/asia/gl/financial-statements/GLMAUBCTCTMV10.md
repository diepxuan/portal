...
### Controller
```php
class GLMAUBCTCTMV10Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV10Repository
{
...
### Model
```php
class GLMAUBCTCTMV10 extends Model
{
