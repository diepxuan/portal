...
### Controller
```php
class GLMAUBCTCTMV20CController extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV20CRepository
{
...
### Model
```php
class GLMAUBCTCTMV20C extends Model
{
