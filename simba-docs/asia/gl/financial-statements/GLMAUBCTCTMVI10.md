...
### Controller
```php
class GLMAUBCTCTMVI10Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMVI10Repository
{
...
### Model
```php
class GLMAUBCTCTMVI10 extends Model
{
