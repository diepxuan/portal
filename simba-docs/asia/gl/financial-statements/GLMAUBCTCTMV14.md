...
- **Dac diem**: 1 tai khoan, loai phat sinh

## Forms

### frmGLMAUBCTCTMV14.cs
- **Ke thua**: frmDMComplexView
- **Chuc nang**: Hien thi danh sach cac chi tieu bao cao

### frmGLMAUBCTCTMV14Edit.cs
...
### Controller
```php
class GLMAUBCTCTMV14Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV14Repository
{
...
### Model
```php
class GLMAUBCTCTMV14 extends Model
{
