...
### Controller
```php
class GLMAUBCTCTMVI02BController extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMVI02BRepository
{
...
### Model
```php
class GLMAUBCTCTMVI02B extends Model
{
