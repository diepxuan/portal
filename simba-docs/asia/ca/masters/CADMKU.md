...
**Validate:**
- Ngày thanh toán >= Ngày ký
- Các TK phải là TK chi tiết

## 3. Stored Procedures

| SP Name | Mô tả |
|---------|-------|
| SP_CADMKU_GET | Lấy danh sách khế ước |
| SP_CADMKU_INSERT | Insert khế ước |
| SP_CADMKU_UPDATE | Update khế ước |
| SP_CADMKU_DELETE | Delete khế ước |
...
- Không áp dụng mapping PHP (đây là form danh mục, không phải voucher)
