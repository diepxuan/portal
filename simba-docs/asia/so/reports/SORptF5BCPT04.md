...
- **Loại**: Report
- **Chức năng**: Báo cáo chi phí F5 theo bộ phận
...
### Controller
```php
// Tương đương frmSORptF5BCPT04.cs
class SORptF5BCPT04Controller extends Controller {
    // TODO: Implement
}
```
...
class SORptF5BCPT04 extends Model {
    // TODO: Implement
}
```
