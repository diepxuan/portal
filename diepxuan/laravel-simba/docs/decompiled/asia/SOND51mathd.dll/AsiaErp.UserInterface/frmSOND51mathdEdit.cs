...
[DesignerGenerated]
public class frmSOND51mathdEdit : frmDMComplexEdit
{
	...
	private void InitializeComponent()
	{
		...
		((Control)txtNoi_nhan).TabIndex = 5;
		...
		((Control)txtDai_dien).TabIndex = 9;
		...
		((Control)txtDia_chi).TabIndex = 11;
		...
		((Control)txtMa_thue).TabIndex = 13;
		...
		((Control)txtPhut_xl).TabIndex = 19;
		...
		((Control)txtNgay_xl).TabIndex = 21;
		...
		((Control)txtNgay_guicqt).TabIndex = 24;
		...
		((Control)btnChon_hd).TabIndex = 25;
		...
		((Control)lblKieu_xl).TabIndex = 27;
		lblKieu_xl.Text = "MAT";
		...
		((Control)this).Name = "frmSOND51mathdEdit";
	...
	protected override bool UpdateDB()
	{
		...
		{
			SOND51mathdDAO sOND51mathdDAO = (SOND51mathdDAO)DAOFactory.CreateDAOInstance("SOND51mathdDAO", "SOND51mathd");
			int num = sOND51mathdDAO.Delete(((TextBox)txtMa_tb).Text);
			sOND51mathdDAO.Destroy();
			InsertToCTHD();
		}
		return result;
	}
	...
	{
		SOND51mathdDAO sOND51mathdDAO = (SOND51mathdDAO)DAOFactory.CreateDAOInstance("SOND51mathdDAO", "SOND51mathd");
		oDthd = sOND51mathdDAO.GetData(ma_tb);
	...
	protected void InsertToCTHD()
	{
		...
		checked
		{
			...
			for (int i = 0; i <= num; i++)
			{
				int num2 = sOND51mathdDAO.Insert(((TextBox)txtMa_tb).Text, ((DataGridView)adgvHD)[0, i].Value.ToString(), ((DataGridView)adgvHD)[1, i].Value.ToString(), ((DataGridView)adgvHD)[2, i].Value.ToString(), ((DataGridView)adgvHD)[3, i].Value.ToString(), ((DataGridView)adgvHD)[4, i].Value.ToString(), ((DataGridView)adgvHD)[5, i].Value.ToString(), ((DataGridView)adgvHD)[6, i].Value.ToString(), ((DataGridView)adgvHD)[7, i].Value.ToString(), ((DataGridView)adgvHD)[8, i].Value.ToString());
			}
			sOND51mathdDAO.Destroy();
		}
	}
