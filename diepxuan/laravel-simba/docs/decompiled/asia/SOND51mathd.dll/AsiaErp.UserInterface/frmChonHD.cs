...
public class frmChonHD : frmAsiaRoot
{
	...
	protected void GetData(string ngay1, string ngay2)
	{
		...
		DataTable data = sOND51mathdDAO.GetData(ngay1, ngay2);
	...
	{
		frmSOND51mathdEdit frmSOND51mathdEdit2 = new frmSOND51mathdEdit();
		checked
		{
			...
			((DataGridView)frmSOND51mathdEdit2.adgvHD).DataSource = f_oDthd;
		}
	}
