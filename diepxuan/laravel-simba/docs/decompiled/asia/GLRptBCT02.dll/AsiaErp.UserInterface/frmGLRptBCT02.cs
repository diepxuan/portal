...
[DesignerGenerated]
public class frmGLRptBCT02 : frmReport
{
	...
	public frmGLRptBCT02(string MenuId)
		: base(MenuId)
	{
		sFilt = "";
		colIndex = 1;
	...
	private void InitializeComponent()
	{
		...
		Label obj2 = lbl2;
		System.Drawing.Point location = new System.Drawing.Point(272, 82);
		((Control)obj2).Location = location;
		Button obj3 = cmdExcel;
		location = new System.Drawing.Point(700, 1120);
		((Control)obj3).Location = location;
		AsMaskedTextBox asMaskedTextBox = txtNgay2;
		location = new System.Drawing.Point(291, 78);
		((Control)asMaskedTextBox).Location = location;
		((Control)txtNgay2).TabIndex = 2;
		Button obj4 = cmdCancel;
		location = new System.Drawing.Point(619, 1120);
		((Control)obj4).Location = location;
		Button obj5 = cmdModifyReport;
		location = new System.Drawing.Point(450, 23);
		((Control)obj5).Location = location;
		((Control)cmdModifyReport).TabIndex = 25;
		AsMaskedTextBox asMaskedTextBox2 = txtNgay1;
		location = new System.Drawing.Point(201, 78);
		((Control)asMaskedTextBox2).Location = location;
		((Control)txtNgay1).TabIndex = 1;
		ComboBox obj6 = cboKyBc;
		location = new System.Drawing.Point(105, 78);
		...
		location = new System.Drawing.Point(19, 56);
		((Control)obj15).Location = location;
		TextBox obj16 = txtTieu_De;
		location = new System.Drawing.Point(105, 52);
		...
		location = new System.Drawing.Point(19, 109);
		...
		location = new System.Drawing.Point(105, 131);
		...
		location = new System.Drawing.Point(193, 134);
		...
		Label obj22 = lblTk;
		location = new System.Drawing.Point(19, 134);
		...
		location = new System.Drawing.Point(105, 157);
		...
		location = new System.Drawing.Point(193, 160);
		...
		location = new System.Drawing.Point(19, 160);
		...
		location = new System.Drawing.Point(193, 186);
		...
		location = new System.Drawing.Point(105, 183);
		...
		location = new System.Drawing.Point(19, 187);
		...
		location = new System.Drawing.Point(105, 105);
	...
	private void Ex2Excel_HTKK()
	{
		...
		string text = SystemInformations.ReportPath + "uTaOut.xls";
		if (!File.Exists(text))
		{
		...
		string text3 = text2 + "BangKeThueRa_Thang" + Conversions.ToString(Conversions.ToDate(txtNgay1.Value).Month).Trim() + "_Nam_" + Conversions.ToDate(txtNgay1.Value).Year.ToString().Trim() + ".xls";
		try
		{
		...
		try
		{
			...
			range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[18, 1]), RuntimeHelpers.GetObjectValue(wSheet.Cells[40, 12]));
			range.Clear();
		}
		catch (Exception ex3)
		{
		...
		rowIndex = 1;
		colIndex = 1;
		sFilt = "ma_thue='KT' and kct=1 and tong_hop=1 and ma_ct<>'' and bold='0'";
		WriteOneGroupData(sFilt, "2. Hàng hoá, dịch vụ chịu thuế suất thuế GTGT 0%:");
		sFilt = "ma_thue='00' and tong_hop=1 and ma_ct<>'' and bold='0'";
		WriteOneGroupData(sFilt, "3. Hàng hoá, dịch vụ chịu thuế suất thuế GTGT 5%:");
		sFilt = "ma_thue='05' and tong_hop=1 and ma_ct<>'' and bold='0'";
		WriteOneGroupData(sFilt, "4. Hàng hoá, dịch vụ chịu thuế suất thuế GTGT 10%:");
		sFilt = "ma_thue='10' and tong_hop=1 and ma_ct<>'' and bold='0'";
		WriteOneGroupData(sFilt, "5. Hàng hóa, dịch vụ không phải tổng hợp trên tờ khai 01/GTGT:");
		sFilt = "kct=1 and tong_hop=0 and ma_ct<>'' and bold='0'";
		WriteOneGroupData(sFilt, "");
		checked
		{
			...
			range.Merge(true);
			NewLateBinding.LateSetComplex(range.Cells[1, 1], (Type)null, "value", new object[1] { "Tổng doanh thu hàng hoá, dịch vụ bán ra:             ............................" }, (string[])null, (Type[])null, false, true);
			rowIndex++;
			range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex, 2]), RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex, 8]));
			range.Merge(true);
			NewLateBinding.LateSetComplex(range.Cells[1, 1], (Type)null, "value", new object[1] { "Tổng thuế GTGT của hàng hóa, dịch vụ bán ra:    ............................" }, (string[])null, (Type[])null, false, true);
			rowIndex += 2;
			range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex, 10]), RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex, 12]));
			range.Merge(true);
			...
			NewLateBinding.LateCall(wSheet.Columns[7, Missing.Value], (Type)null, "AutoFit", new object[0], (string[])null, (Type[])null, (bool[])null, true);
			NewLateBinding.LateCall(wSheet.Columns[9, Missing.Value], (Type)null, "AutoFit", new object[0], (string[])null, (Type[])null, (bool[])null, true);
	...
	private void WriteOneGroupData(string sMa_thue, string sNextGroupTitle)
	{
		this.i = 1;
		DataRow[] array = get_MyDGVSource(isSet2Print: true).Select(sFilt, "ngay_ct,so_ct");
		checked
		{
			if (array.Length > 0)
			{
				...
				range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex - 2, 2]), RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex - num - 1, 12]));
				range.Clear();
				range.NumberFormat = "@";
				range.Value2 = array2;
				...
				range.NumberFormat = "@";
				range.HorizontalAlignment = XlHAlign.xlHAlignLeft;
				range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex - 2, 10]), RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex - num - 1, 11]));
				range.NumberFormat = "#,##";
			...
			else
			{
				try
				{
					range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex - 1, 2]), RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex - 1, 12]));
					range.Borders[XlBordersIndex.xlEdgeTop].LineStyle = XlLineStyle.xlContinuous;
					range.Borders[XlBordersIndex.xlEdgeBottom].LineStyle = XlLineStyle.xlContinuous;
					range.Borders[XlBordersIndex.xlEdgeLeft].LineStyle = XlLineStyle.xlContinuous;
					range.Borders[XlBordersIndex.xlEdgeRight].LineStyle = XlLineStyle.xlContinuous;
			...
			range = ((_Worksheet)wSheet).get_Range(RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex, 2]), RuntimeHelpers.GetObjectValue(wSheet.Cells[startIndex + rowIndex, 12]));
