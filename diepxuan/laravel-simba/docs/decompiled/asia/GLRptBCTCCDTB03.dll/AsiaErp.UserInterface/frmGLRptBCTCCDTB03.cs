...
[DesignerGenerated]
public class frmGLRptBCTCCDTB03 : frmReport
{
	...
	[AccessedThroughProperty("txtBacTk")]
	private AsTextNumeric _txtBacTk;

	[AccessedThroughProperty("lblBacTk")]
	private Label _lblBacTk;
	...
	internal virtual AsTextNumeric txtBacTk
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual Label lblBacTk
	{
		[DebuggerNonUserCode]
		get
		{
	...
	public frmGLRptBCTCCDTB03(string menuid)
		: base(menuid)
	{
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		((Control)tabFilter).Controls.Add((Control)(object)txtBacTk);
		((Control)tabFilter).Controls.Add((Control)(object)lblBacTk);
		...
		((Control)tabFilter).Controls.SetChildIndex((Control)(object)lblBacTk, 0);
		((Control)tabFilter).Controls.SetChildIndex((Control)(object)txtBacTk, 0);
		Label obj = lbl2;
		...
		location = new Point(26, 159);
		((Control)obj10).Location = location;
		((Control)lblMa_nt).Visible = false;
		Button obj11 = cmdOk;
		location = new Point(26, 187);
		...
		txtBacTk.DecimalSymbol = ".";
		txtBacTk.HotKey = (Keys)13;
		AsTextNumeric asTextNumeric = txtBacTk;
		location = new Point(114, 129);
		((Control)asTextNumeric).Location = location;
		txtBacTk.Mask = "### ### ### ###";
		((Control)txtBacTk).Name = "txtBacTk";
		AsTextNumeric asTextNumeric2 = txtBacTk;
		size = new Size(100, 20);
		((Control)asTextNumeric2).Size = size;
		txtBacTk.SpecialType = Commons.NumericSpecialType.Other;
		((Control)txtBacTk).TabIndex = 5;
		((TextBox)txtBacTk).Text = "0";
		((TextBox)txtBacTk).TextAlign = (HorizontalAlignment)1;
		txtBacTk.Type = Commons.NumericType.ORTHER_;
		txtBacTk.Value = 0;
		lblBacTk.AutoSize = true;
		Label obj18 = lblBacTk;
		location = new Point(26, 132);
		((Control)obj18).Location = location;
		((Control)lblBacTk).Name = "lblBacTk";
		Label obj19 = lblBacTk;
		size = new Size(73, 13);
		((Control)obj19).Size = size;
		((Control)lblBacTk).TabIndex = 1149;
		lblBacTk.Text = "Bậc tài khoản";
		...
		((Control)this).Name = "frmGLRptBCTCCDTB03";
		((Form)this).Text = "frmGLRptBCTCCDTB03";
	...
	protected override void InitOtherComponents()
	{
		...
		((TextBox)txtBacTk).Text = MyMenuInfo.par2;
	}
	...
	protected override bool LoadData()
	{
		...
		arrayList.Add(((TextBox)txtBacTk).Text);
	...
	private string GetFilterTitle()
	{
		...
		{
			text = lblTk.Text + ": [" + ((TextBox)txtTk).Text + " - " + lblTen_Tk.Text + "]; ";
		}
		if (Operators.CompareString(((TextBox)txtBacTk).Text, "", false) != 0)
		{
			text = text + lblBacTk.Text + ": [" + ((TextBox)txtBacTk).Text + "]; ";
		}
		return text;
	}
}
