...
[DesignerGenerated]
public class frmPOVchPO5Find : frmVoucherFind
{
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(93, 453);
		...
		((Control)lblTen_httt).TabIndex = 284;
