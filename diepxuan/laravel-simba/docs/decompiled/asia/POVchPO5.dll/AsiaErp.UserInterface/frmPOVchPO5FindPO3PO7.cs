...
[DesignerGenerated]
public class frmPOVchPO5FindPO3PO7 : frmAsiaRoot
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPOVchPO5FindPO3PO7));
		...
		Point location = new Point(91, 187);
		...
		((Control)this).Name = "frmPOVchPO5FindPO3PO7";
		((Form)this).Text = "Chon HD";
	...
	private void cmdOk_Click(object sender, EventArgs e)
	{
		...
		sWhereKey = "Ma_Cty='" + CompanyInformations.CompanyID + "' and ma_kh='" + sMa_kh + "'";
