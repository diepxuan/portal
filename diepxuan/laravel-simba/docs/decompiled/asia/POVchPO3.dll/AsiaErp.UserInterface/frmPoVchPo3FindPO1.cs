...
[DesignerGenerated]
public class frmPoVchPo3FindPO1 : frmAsiaRoot
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmPoVchPo3FindPO1));
		...
		Point location = new Point(91, 188);
		...
		((Control)txtNgay_hd2).TabIndex = 2;
		...
		((Control)txtNgay_hd1).TabIndex = 1;
		...
		((Control)this).Name = "frmPoVchPo3FindPO1";
		((Form)this).Text = "Chon DH";
	...
	private void cmdOk_Click(object sender, EventArgs e)
	{
		...
		sWhereKey = "Ma_Cty='" + CompanyInformations.CompanyID + "' and ma_kh like '" + ((TextBox)txtMa_Kh).Text + "%'";
