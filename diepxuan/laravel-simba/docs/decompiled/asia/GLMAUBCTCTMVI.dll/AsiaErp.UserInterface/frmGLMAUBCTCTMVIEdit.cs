...
[DesignerGenerated]
public class frmGLMAUBCTCTMVIEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVIEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMVVIEdit_Load;
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMVVIEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
