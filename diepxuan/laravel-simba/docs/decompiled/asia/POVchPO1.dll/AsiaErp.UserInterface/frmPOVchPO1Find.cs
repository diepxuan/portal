...
[DesignerGenerated]
public class frmPOVchPO1Find : frmVoucherFind
{
	...
	[AccessedThroughProperty("txtSo_Pdn")]
	private TextBox _txtSo_Pdn;
	...
	internal virtual TextBox txtSo_Pdn
	{
		[DebuggerNonUserCode]
		get
		{
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(93, 405);
		...
		((Control)gbCt).Controls.Add((Control)(object)txtSo_Pdn);
		...
		GroupBox obj5 = gbCt;
		size = new Size(718, 206);
		((Control)obj5).Size = size;
		TextBox obj6 = txtSo_Ct1;
		location = new Point(138, 46);
		...
		location = new Point(318, 47);
		((Control)obj7).Location = location;
		Label obj8 = lblSo_Ct2;
		location = new Point(251, 51);
		((Control)obj8).Location = location;
		Label obj9 = lblNgay_Ct2;
		location = new Point(251, 24);
		...
		((Control)Label2).TabIndex = 232;
		Label2.Text = "Số phiếu ĐN";
		TextBox obj35 = txtSo_Pdn;
		location = new Point(138, 176);
		((Control)obj35).Location = location;
		((TextBoxBase)txtSo_Pdn).MaxLength = 30;
		((Control)txtSo_Pdn).Name = "txtSo_Pdn";
		TextBox obj36 = txtSo_Pdn;
		size = new Size(95, 20);
		((Control)obj36).Size = size;
		((Control)txtSo_Pdn).TabIndex = 6;
		...
		((Control)lblTen_Bp).TabIndex = 1294;
