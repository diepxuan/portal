...
public class MsSqlSIMaintainDAO : MsSqlDAO, SIMaintainDAO
{
	[DebuggerNonUserCode]
	public MsSqlSIMaintainDAO()
	{
	}
	...
	DataTable SIMaintainDAO.GetDSMa()
	{
	...
	int SIMaintainDAO.ExecuteDelSpace(string pMa_cty, string pLst_Ma)
	{
	...
	int SIMaintainDAO.BackupDB(string pStr_Path)
	{
	...
	int SIMaintainDAO.CreateAutoBackupDB(params object[] para)
	{
	...
	int SIMaintainDAO.ExecuteReIndex()
	{
