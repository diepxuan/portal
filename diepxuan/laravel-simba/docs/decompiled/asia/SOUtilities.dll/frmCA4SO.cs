...
[DesignerGenerated]
public class frmCA4SO : frmAsiaRoot
{
	...
	[AccessedThroughProperty("rbCA3")]
	private RadioButton _rbCA3;

	[AccessedThroughProperty("rbCA1")]
	private RadioButton _rbCA1;
	...
	[AccessedThroughProperty("lblDa_thu")]
	private Label _lblDa_thu;
	...
	public MenuInformation f_CA1_MenuInfo;

	public MenuInformation f_CA3_MenuInfo;
	...
	private ReportInformation f_oReportInfo;
	...
	private decimal f_T_tien_nt;

	private decimal f_t_tien;

	public MsSqlCA4SODAO f_oDAO;
	...
	public virtual AsTextBox txtTk_No
	{
		[DebuggerNonUserCode]
		get
		{
	...
	public virtual RadioButton rbCA3
	{
		[DebuggerNonUserCode]
		get
		{
		...
		set
		{
			EventHandler eventHandler = rbCA3_CheckedChanged;
			if (_rbCA3 != null)
			{
				_rbCA3.CheckedChanged -= eventHandler;
			}
			_rbCA3 = value;
			if (_rbCA3 != null)
			{
	...
	public virtual RadioButton rbCA1
	{
		[DebuggerNonUserCode]
		get
		{
		...
		set
		{
			...
			if (_rbCA1 != null)
			{
				_rbCA1.CheckedChanged -= eventHandler;
			}
			_rbCA1 = value;
			if (_rbCA1 != null)
			{
	...
	internal virtual Label lblDa_thu
	{
		[DebuggerNonUserCode]
		get
		{
	...
	public MsSqlCA4SODAO MyDAO
	{
		get
		{
			if (f_oDAO == null)
			{
				try
				{
					f_oDAO = (MsSqlCA4SODAO)DAOFactory.CreateDAOInstance("CA4SODAO", "SOUtilities");
				}
				catch (Exception ex)
				{
	...
	public frmCA4SO()
	{
		((Form)this).Load += frmCa14So4_Load;
		__ENCAddToList(this);
		f_mode = "M";
		isLoading = true;
		f_stt_rec = "ASIASOFT";
	...
	public frmCA4SO(string menuid, string aStt_rec_hd)
		: base(menuid)
	{
		((Form)this).Load += frmCa14So4_Load;
		__ENCAddToList(this);
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmCA4SO));
		...
		Label1 = new Label();
		rbCA3 = new RadioButton();
		rbCA1 = new RadioButton();
		...
		((Control)gbLine).Controls.Add((Control)(object)rbCA3);
		((Control)gbLine).Controls.Add((Control)(object)rbCA1);
		...
		((Control)txtT_tt_nt).TabIndex = 1065;
		...
		((ButtonBase)rbCA3).AutoSize = true;
		RadioButton obj25 = rbCA3;
		location = new Point(231, 19);
		((Control)obj25).Location = location;
		((Control)rbCA3).Name = "rbCA3";
		RadioButton obj26 = rbCA3;
		size = new Size(59, 17);
		((Control)obj26).Size = size;
		((Control)rbCA3).TabIndex = 99;
		((ButtonBase)rbCA3).Text = "Báo có";
		((ButtonBase)rbCA3).UseVisualStyleBackColor = true;
		((ButtonBase)rbCA1).AutoSize = true;
		rbCA1.Checked = true;
		RadioButton obj27 = rbCA1;
		location = new Point(135, 19);
		((Control)obj27).Location = location;
		((Control)rbCA1).Name = "rbCA1";
		RadioButton obj28 = rbCA1;
		size = new Size(70, 17);
		((Control)obj28).Size = size;
		((Control)rbCA1).TabIndex = 0;
		rbCA1.TabStop = true;
		((ButtonBase)rbCA1).Text = "Phiếu thu";
		((ButtonBase)rbCA1).UseVisualStyleBackColor = true;
		...
		((Control)lblDa_thu).Anchor = (AnchorStyles)6;
		lblDa_thu.AutoSize = true;
		((Control)lblDa_thu).Font = new Font("Microsoft Sans Serif", 10f, (FontStyle)1, (GraphicsUnit)3, (byte)0);
		((Control)lblDa_thu).ForeColor = Color.Red;
		lblDa_thu.ImeMode = (ImeMode)0;
		Label obj33 = lblDa_thu;
		location = new Point(524, 364);
		((Control)obj33).Location = location;
		((Control)lblDa_thu).Name = "lblDa_thu";
		Label obj34 = lblDa_thu;
		size = new Size(68, 17);
		((Control)obj34).Size = size;
		((Control)lblDa_thu).TabIndex = 1066;
		lblDa_thu.Text = "(Đã thu)";
		((Control)lblDa_thu).Visible = false;
		...
		((DataGridViewColumn)dgvcTk).HeaderText = "Tk có";
		...
		((DataGridViewColumn)dgvcTk).ToolTipText = "Tài khoản có";
		((DataGridViewColumn)dgvcTk).Width = 70;
		((DataGridViewColumn)dgvcTen_tk).DataPropertyName = "ten_tk";
		((DataGridViewColumn)dgvcTen_tk).HeaderText = "Tên tài khoản có";
		...
		val5.Format = "### ### ### ###.##";
		((DataGridViewColumn)dgvcPs_co_nt).DefaultCellStyle = val5;
		...
		size = new Size(602, 398);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)adgvDetail);
		((Control)this).Controls.Add((Control)(object)lblDa_thu);
		...
		((Control)this).Name = "frmCA4SO";
		((Form)this).Text = "frmCa14So4";
	...
	private void frmCa14So4_Load(object sender, EventArgs e)
	{
		((DataGridView)adgvDetail).DataSource = f_oTblCt;
		f_T_tien_nt = Conversions.ToDecimal(f_oTblCt.Compute("sum(ps_co_nt)", ""));
		f_t_tien = Conversions.ToDecimal(f_oTblCt.Compute("sum(ps_co)", ""));
		...
		if (Operators.CompareString(f_mode, "X", false) == 0)
		{
			...
			((Control)lblDa_thu).Visible = true;
	...
	private void Save2DB()
	{
		...
		isOK = MyDAO.SOSaveCAPH4SO(ref f_stt_rec, f_CAVoucherInfo.voucher_code, f_stt_rec_hd, Conversions.ToDate(txtNgay_Ct.Value), txtSo_Ct.Text, f_Ma_kh, f_Dia_chi_kh, txtNguoi_Gd.Text, txtDien_giai.Text, f_Ma_nt, f_Ty_gia, f_T_tien_nt, f_t_tien, ((TextBox)txtTk_No).Text, SystemInformations.UserName);
		if (!isOK)
		{
			MyDAO.RollBackTrans();
			return;
		...
		foreach (DataRow row in f_oTblCt.Rows)
		{
			...
			row.EndEdit();
			isOK = Conversions.ToBoolean(MyDAO.SOSaveCACT4SO(row));
			if (!isOK)
			{
				MyDAO.RollBackTrans();
				return;
	...
	private void rbCA3_CheckedChanged(object sender, EventArgs e)
	{
		if (Operators.CompareString(f_mode, "X", false) != 0)
		{
			ValidLoaiChungTu();
	...
	private void ValidLoaiChungTu()
	{
		if (!isLoading)
		{
			if (rbCA1.Checked)
			{
				MyMenuInfo = f_CA1_MenuInfo;
			}
			else
			{
				MyMenuInfo = f_CA3_MenuInfo;
			}
			...
			if (Operators.CompareString(f_mode, "M", false) == 0)
			{
				...
				((TextBox)txtTk_No).Text = AsiaErp.Framework.Environment.GetSiDMCTByMa_Ct(f_CAVoucherInfo.voucher_code).tk_no;
				txtTk_No.SeekDM();
				((Control)cmdPrint).Enabled = false;
				((Control)cmdPrint).Visible = false;
			}
	...
	protected virtual void SetReportFomularFields()
	{
		...
		formulaFields["tk_no"].Text = "\"" + ((TextBox)txtTk_No).Text + "\"";
		if (f_oRptFomularFields != null)
		{
		...
		checked
		{
			foreach (object row in dataTable.Rows)
			{
				...
				{
					num++;
					formulaFields["Tk_Co" + num.ToString().Trim()].Text = Conversions.ToString(Operators.AddObject(Operators.AddObject((object)"\"", Helper.Repl_Null(RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet(objectValue, new object[1] { "Tk" }, (string[])null)), isNum: false)), (object)"\""));
					formulaFields["Ps_Co" + num.ToString().Trim()].Text = "\"" + Helper.Repl_Null(RuntimeHelpers.GetObjectValue(NewLateBinding.LateIndexGet(objectValue, new object[1] { "Ps_Co_Nt" }, (string[])null)), isNum: true).ToString() + "\"";
				}
			}
			int num2 = num + 1;
			while (true)
			{
				...
				if (num3 <= num4)
				{
					formulaFields["Tk_co" + num2.ToString().Trim()].Text = "\"\"";
					formulaFields["Ps_co" + num2.ToString().Trim()].Text = "\"\"";
					num2++;
					continue;
				}
				break;
