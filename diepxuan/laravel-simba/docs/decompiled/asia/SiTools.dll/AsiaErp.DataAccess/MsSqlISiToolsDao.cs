...
public class MsSqlISiToolsDao : MsSqlDAO, ISiToolsDao
{
	...
	{
		return GetDataTable("asGetCompanyInfo", CompanyInformations.CompanyID, SystemInformations.CurrentCultureName);
	}
	...
	{
		_command.CommandType = CommandType.StoredProcedure;
		_command.CommandText = "asSysCreateCompany";
		_command.Parameters.Clear();
	...
	public int SiInsertReportRex(DataRow dr)
	{
		...
		_command.Parameters.AddWithValue("@pAuto_format", RuntimeHelpers.GetObjectValue(Helper.Repl_Null(RuntimeHelpers.GetObjectValue(dr["Auto_format"]), isNum: true)));
	...
	int ISiToolsDao.DynInsertUpdateDeleteData(string pXmlData, string pTableName, string pMode, string pKeyColumns = "")
	{
