...
[DesignerGenerated]
public class frmGLMAUBCTCTMV20CEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV20CEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV20CEdit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(255, 284);
		...
		((Control)Label5).TabIndex = 152;
		Label5.Text = "Tài khoản 2";
	...
	private void frmGLMAUBCTCTMV20CEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
