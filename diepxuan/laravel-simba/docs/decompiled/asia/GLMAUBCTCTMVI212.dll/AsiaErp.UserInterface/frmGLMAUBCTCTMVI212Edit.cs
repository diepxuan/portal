...
[DesignerGenerated]
public class frmGLMAUBCTCTMVI212Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVI212Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMIEdit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMIEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
