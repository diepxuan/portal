# Báo cáo Phân tích DLL: GLMAUBCTCTMVI10.dll
...
```
GLMAUBCTCTMVI10.dll/
├── GLMAUBCTCTMVI10.csproj       # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMVI10.cs    # Main view form class
│   └── frmGLMAUBCTCTMVI10Edit.cs # Edit form class
...
|-------|---------|----------|
| `frmGLMAUBCTCTMVI10` | `frmDMComplexView` | Form xem danh sách mẫu báo cáo tài chính I10 |
| `frmGLMAUBCTCTMVI10Edit` | `frmDMComplexEdit` | Form chỉnh sửa mẫu báo cáo tài chính I10 |
...
### Form Edit (frmGLMAUBCTCTMVI10Edit)
...
| txtTk1 - txtTk7 | AsTextBox | Tài khoản từ 1 đến 7 |
| lblTK1 - lblTK7 | Label | Nhãn tài khoản |
...
**GLMAUBCTCTMVI10.dll là module quản lý mẫu báo cáo tài chính I10** trong hệ thống ERP của Asia Software.

### Chức năng chính

#### 1. Quản lý mẫu báo cáo tài chính I10
- Định nghĩa mã chỉ tiêu báo cáo
- Quản lý tên chỉ tiêu và nội dung
- Cấu hình cách tính cho từng chỉ tiêu
- Hỗ trợ đến 7 tài khoản kế toán (tk1-tk7)
...
Đây là một module Windows Forms của hệ thống ERP Asia, phục vụ cho việc cấu hình mẫu báo cáo tài chính I10 - một loại báo cáo tài chính theo quy định của Việt Nam.
