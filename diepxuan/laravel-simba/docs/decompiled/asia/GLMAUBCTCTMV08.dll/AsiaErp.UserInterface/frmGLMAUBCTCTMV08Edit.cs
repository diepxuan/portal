...
[DesignerGenerated]
public class frmGLMAUBCTCTMV08Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV08Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV08Edit_Load;
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMV08Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
