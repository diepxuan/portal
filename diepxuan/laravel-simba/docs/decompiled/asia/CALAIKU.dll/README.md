...
| SP Name | Mô tả |
|---------|-------|
| (Theo cấu hình Controller) | Lấy danh sách lãi khế ước |
| (Theo cấu hình Controller) | Update lãi khế ước |

## 4. Mapping PHP

Không áp dụng (đây là form danh mục phức tạp, không phải voucher).
