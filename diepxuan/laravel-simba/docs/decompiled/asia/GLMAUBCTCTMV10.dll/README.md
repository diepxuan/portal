# Báo cáo Phân tích DLL: GLMAUBCTCTMV10.dll
...
| Thuộc tính | Giá trị |
|------------|---------|
| Assembly Name | GLMAUBCTCTMV10 |
| Assembly Title | GLBCTC07V09 (lưu ý: Title giống V09) |
| Assembly Product | GLBCTC07V09 (lưu ý: Product giống V09) |
| Assembly Copyright | Copyright © 2012 |
| Assembly Version | 1.0.0.0 |
| Assembly File Version | 1.0.0.0 |
| GUID | de80061a-33f9-4bf2-9939-3a34f3f95c1a (lưu ý: GUID giống V09) |
| ComVisible | false |
...
```
GLMAUBCTCTMV10.dll/
├── GLMAUBCTCTMV10.csproj        # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMV10.cs     # Main form class (view)
│   └── frmGLMAUBCTCTMV10Edit.cs # Edit form class
...
|-------|---------|----------|
| `frmGLMAUBCTCTMV10` | `frmDMComplexView` | Form xem danh sách chỉ tiêu báo cáo tài chính V10 |
| `frmGLMAUBCTCTMV10Edit` | `frmDMComplexEdit` | Form nhập liệu chỉ tiêu báo cáo tài chính V10 |

---

## Các trường dữ liệu chính (frmGLMAUBCTCTMV10Edit)
...
**GLMAUBCTCTMV10.dll là module quản lý mẫu báo cáo tài chính V10** trong hệ thống ERP của Asia Software Development JSC.
...
V10 có metadata (Title, Product, GUID) giống với V09, có thể là phiên bản cập nhật hoặc biến thể của V09 cho mẫu báo cáo khác.

---

## Kết luận

Đây là module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc cấu hình và quản lý mẫu báo cáo tài chính V10 - một mẫu báo cáo theo quy định của Bộ Tài chính Việt Nam.
