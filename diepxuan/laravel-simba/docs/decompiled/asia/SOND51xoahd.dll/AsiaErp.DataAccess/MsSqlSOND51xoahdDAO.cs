...
public class MsSqlSOND51xoahdDAO : MsSqlDAO, SOND51xoahdDAO
{
	[DebuggerNonUserCode]
	public MsSqlSOND51xoahdDAO()
	{
	}
	...
	public DataTable GetData(string ma_tb)
	{
		...
		_command.Parameters.AddWithValue("@pKieu_xl", (object)"XOA");
		_command.Parameters.AddWithValue("@pMa_tb", (object)ma_tb);
		return GetDataTable();
	}

	DataTable SOND51xoahdDAO.GetData(string ma_tb)
	{
	...
	DataTable SOND51xoahdDAO.GetData(string ngay1, string ngay2)
	{
		//ILSpy generated this explicit interface implementation from .override directive in GetData
	...
	int SOND51xoahdDAO.Insert(string ma_tb, string ma_chung, string ten_loai, string mau_so, string so_seri, string tu_so, string den_so, string so_luong, string lien_hd, string ghi_chu)
	{
	...
	int SOND51xoahdDAO.Delete(string ma_tb)
	{
