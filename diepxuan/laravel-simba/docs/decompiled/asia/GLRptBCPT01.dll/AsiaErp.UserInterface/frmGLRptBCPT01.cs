...
[DesignerGenerated]
public class frmGLRptBCPT01 : frmReport
{
	...
	private void InitializeComponent()
	{
		...
		Button obj8 = cmdOk;
		location = new Point(27, 163);
		((Control)obj8).Location = location;
		((Control)cmdOk).TabIndex = 7;
		((Control)lblTieu_de).TabIndex = 16;
		...
		((Control)lblTen_Tk).TabIndex = 1077;
		...
		((Control)this).Name = "frmGLRptBCPT01";
		((Form)this).Text = "frmGLRptBCPT01";
	...
	public frmGLRptBCPT01(string Menuid)
		: base(Menuid)
	{
		lock (__ENCList)
		{
	...
	protected override bool LoadData()
	{
		...
		base.MyFomularFields.Add("strTK", "Tài khoản :" + ((TextBox)txtTk).Text + "- " + lblTen_Tk.Text);
		return true;
	}
