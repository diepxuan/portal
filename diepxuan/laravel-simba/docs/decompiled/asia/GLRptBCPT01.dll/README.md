# Báo cáo Phân tích DLL: GLRptBCPT01.dll
...
| Thuộc tính | Giá trị |
|------------|---------|
| Assembly Name | GLRptBCPT01 |
| Assembly Title | Bảng cân đối phát sinh các tiểu tài khoản của một tài khoản |
| Assembly Product | GLRptBCPT01 |
| Assembly Company | - |
| Assembly Copyright | Copyright © 2010 |
| Assembly Trademark | - |
| Assembly Version | 1.0.0.0 |
| Assembly File Version | 1.0.0.0 |
| GUID | 6eeae821-b0c5-49db-8dc4-23548365ebd2 |
| ComVisible | false |
...
```
GLRptBCPT01.dll/
├── GLRptBCPT01.csproj             # Project file
├── app.ico                          # Application icon
├── Properties/
│   └── AssemblyInfo.cs              # Assembly metadata
├── AsiaErp.UserInterface/
│   └── frmGLRptBCPT01.cs          # Main report form
...
|-------|---------|----------|
| `frmGLRptBCPT01` | `frmReport` | Form báo cáo cân đối phát sinh tiểu tài khoản |
...
- "Bảng cân đối phát sinh các tiểu tài khoản của một tài khoản" - Tên chức năng chính
- "Tài khoản" - TK cần xem chi tiết các tiểu tài khoản

### Thuật ngữ kế toán

| Thuật ngữ | Ý nghĩa |
|-----------|----------|
| `tk` | Tài khoản tổng hợp |
| `ma_nt` | Mã ngoại tệ |
| `ngay1`, `ngay2` | Khoảng thời gian báo cáo |
| `strTK` | Thông tin tài khoản hiển thị trên báo cáo |
...
**GLRptBCPT01.dll là module báo cáo "Bảng cân đối phát sinh các tiểu tài khoản của một tài khoản"** trong hệ thống ERP.
...
Đây là module báo cáo cân đối phát sinh theo tiểu tài khoản trong hệ thống ERP Asia Enterprise, cho phép xem chi tiết các tiểu tài khoản thuộc một tài khoản tổng hợp.
