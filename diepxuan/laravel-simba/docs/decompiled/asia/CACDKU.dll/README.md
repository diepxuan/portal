...
| SP Name | Mô tả |
|---------|-------|
| (Theo cấu hình Controller) | Lấy danh sách số dư đầu kỳ KU |
| (Theo cấu hình Controller) | Insert/Update số dư đầu kỳ KU |

## 4. Mapping PHP

Không áp dụng (đây là form số dư đầu kỳ, không phải voucher).
