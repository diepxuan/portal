# Báo cáo Phân tích DLL: GLMAUBCTCTMVI02B.dll
...
| Thuộc tính | Giá trị |
|------------|---------|
| Assembly Name | GLMAUBCTCTMVI02B |
...
```
GLMAUBCTCTMVI02B.dll/
├── GLMAUBCTCTMVI02B.csproj      # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMVI02B.cs   # Main form class (View)
│   └── frmGLMAUBCTCTMVI02BEdit.cs # Edit form class
...
|-------|---------|----------|
| `frmGLMAUBCTCTMVI02B` | `frmDMComplexView` | Form xem danh sách mẫu báo cáo tài chính I02B |
| `frmGLMAUBCTCTMVI02BEdit` | `frmDMComplexEdit` | Form chỉnh sửa chỉ tiêu báo cáo |

---

## Form Controls (frmGLMAUBCTCTMVI02BEdit)
...
**GLMAUBCTCTMVI02B.dll là module quản lý mẫu Báo cáo tài chính I02B** trong hệ thống ERP của Asia Software.

### Chức năng chính

#### 1. Quản lý chỉ tiêu báo cáo tài chính
- Định nghĩa mã chỉ tiêu (ma_so) theo quyết định I02B
...
**I02B** - Mẫu báo cáo tài chính theo quyết định số I02B (Thông tư kế toán Việt Nam).

---

## Kết luận

Đây là module Windows Forms của hệ thống ERP Asia, phục vụ cho việc cấu hình và quản lý mẫu Báo cáo tài chính theo quyết định I02B.
