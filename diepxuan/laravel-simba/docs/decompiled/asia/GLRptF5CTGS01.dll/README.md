# Báo cáo Phân tích DLL: GLRptF5CTGS01.dll
...
```
GLRptF5CTGS01.dll/
├── GLRptF5CTGS01.csproj        # Project file
├── app.ico                       # Application icon
├── Properties/
│   └── AssemblyInfo.cs           # Assembly metadata
├── AsiaErp.UserInterface/
│   └── frmGLRptF5CTGS01.cs   # Main form class (Drilldown Report)
...
|-------|---------|----------|
| `frmGLRptF5CTGS01` | `frmDrilldownReport` | Form báo cáo F5 CTGS01 |

---

## Chi tiết Form: frmGLRptF5CTGS01
...
| `frmGLRptF5CTGS01(...)` | ReportInformation, drilldownMenuId, AsDictionary, bool, string, string, string, object, params object[] | Constructor với thông tin báo cáo |
...
**GLRptF5CTGS01.dll là module báo cáo F5 CTGS01** trong hệ thống ERP của Asia Software.

### Chức năng chính

#### 1. Báo cáo CTGS01 (Chứng từ ghi sổ)
- Hiển thị báo cáo chứng từ ghi sổ theo mẫu CTGS01
...
Đây là module báo cáo Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc hiển thị báo cáo chứng từ ghi sổ CTGS01. Module này đơn giản, chủ yếu dùng để hiển thị dữ liệu với khả năng drilldown cơ bản từ base class.
