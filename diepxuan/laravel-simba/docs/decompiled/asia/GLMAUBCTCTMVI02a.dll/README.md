# Báo cáo Phân tích DLL: GLMAUBCTCTMVI02a.dll
...
| Thuộc tính | Giá trị |
|------------|---------|
| Assembly Name | GLMAUBCTCTMVI02a |
...
```
GLMAUBCTCTMVI02a.dll/
├── GLMAUBCTCTMVI02a.csproj      # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMVI02a.cs   # Main form class (View)
│   └── frmGLMAUBCTCTMVI02aEdit.cs # Edit form class
...
|-------|---------|----------|
| `frmGLMAUBCTCTMVI02a` | `frmDMComplexView` | Form xem danh sách mẫu báo cáo tài chính I02a |
| `frmGLMAUBCTCTMVI02aEdit` | `frmDMComplexEdit` | Form chỉnh sửa chỉ tiêu báo cáo |

---

## Form Controls (frmGLMAUBCTCTMVI02aEdit)
...
**GLMAUBCTCTMVI02a.dll là module quản lý mẫu Báo cáo tài chính I02a** trong hệ thống ERP của Asia Software.

### Chức năng chính

#### 1. Quản lý chỉ tiêu báo cáo tài chính
- Định nghĩa mã chỉ tiêu (ma_so) theo quyết định I02a
...
**I02a** - Mẫu báo cáo tài chính theo quyết định số I02a (Thông tư kế toán Việt Nam).

---

## Kết luận

Đây là module Windows Forms của hệ thống ERP Asia, phục vụ cho việc cấu hình và quản lý mẫu Báo cáo tài chính theo quyết định I02a.
