...
[DesignerGenerated]
public class frmGLMAUBCTCTMV12Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV12Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV12Edit_Load;
		InitializeComponent();
	}
	...
	private void frmGLMAUBCTCTMV12Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
