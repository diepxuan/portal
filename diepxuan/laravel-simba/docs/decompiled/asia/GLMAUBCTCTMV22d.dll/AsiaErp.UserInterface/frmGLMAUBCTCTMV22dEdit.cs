...
[DesignerGenerated]
public class frmGLMAUBCTCTMV22dEdit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV22dEdit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV22dEdit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(259, 241);
		...
		size = new Size(645, 315);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMV22dEdit";
	...
	private void frmGLMAUBCTCTMV22dEdit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
