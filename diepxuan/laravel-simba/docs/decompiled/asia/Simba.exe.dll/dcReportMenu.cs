...
public class dcReportMenu : DockContent
{
	[CompilerGenerated]
	internal class _Closure_0024__4
	{
		public MenuInformation _0024VB_0024Local_parent;

		[DebuggerNonUserCode]
		public _Closure_0024__4(_Closure_0024__4 other)
		{
			if (other != null)
			{
	...
	private static readonly Font REPORT_LINK_FONT = new Font(FontFamily.GenericSansSerif, 9f, (FontStyle)0);
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(dcReportMenu));
	...
	internal void InitMenu(IOrderedEnumerable<MenuInformation> mnuEnum)
	{
		...
		int num9 = 0;
		_Closure_0024__4 closure_0024__ = default(_Closure_0024__4);
		...
		while (true)
		{
			...
			closure_0024__ = new _Closure_0024__4(closure_0024__);
			...
			IOrderedEnumerable<MenuInformation> source3 = from mnu in mnuEnum.Where(closure_0024__._Lambda_0024__124)
				select (mnu) into mnu
				orderby mnu.stt
				select mnu;
		...
		if ((source.Count() > 0 && source.Count() <= 2) ? true : false)
		{
	...
	private void LinkMenu_Clicked(object sender, LinkLabelLinkClickedEventArgs e)
	{
		...
		Menu_Clicked?.Invoke(RuntimeHelpers.GetObjectValue(objectValue), (EventArgs)(object)e);
	}

	private void FlowLayoutPanel1_Paint(object sender, PaintEventArgs e)
	{
		e.Graphics.DrawLine(Pens.DarkGray, 0, 0, 0, ((Control)FlowLayoutPanel1).Height - 2);
	}
