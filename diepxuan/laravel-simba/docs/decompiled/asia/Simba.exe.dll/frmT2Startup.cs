...
[DesignerGenerated]
public class frmT2Startup : Form
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmT2Startup));
	...
	{
		frmT2DetailMenu frmT2DetailMenu2 = new frmT2DetailMenu();
		frmT2ModuleMenu frmT2ModuleMenu2 = new frmT2ModuleMenu();
		frmT2ModuleMenu2.panelDetailMenus = (Panel)(object)frmT2DetailMenu2.panelDetailMenus;
		frmT2ModuleMenu2.lblCurrentModule = frmT2DetailMenu2.lblCurrentModule;
		frmT2DetailMenu2.Show(DockPanelMain, DockState.Document);
		frmT2ModuleMenu2.Show(DockPanelMain, DockState.DockLeft);
		try
		{
	...
	protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
	{
		...
		if (((Message)(ref msg)).Msg == 256)
		{
			...
			{
				LinkLabel val3 = (LinkLabel)((ContainerControl)(frmT2DetailMenu)DockPanelMain.Contents[0].DockHandler.DockPanel.ActiveDocument).ActiveControl;
