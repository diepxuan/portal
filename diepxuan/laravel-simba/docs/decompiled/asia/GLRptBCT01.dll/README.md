# Báo cáo Phân tích DLL: GLRptBCT01.dll
...
```
GLRptBCT01.dll/
├── GLRptBCT01.csproj              # Project file
├── app.ico                          # Application icon
├── Properties/
│   └── AssemblyInfo.cs              # Assembly metadata
└── AsiaErp.UserInterface/
    └── frmGLRptBCT01.cs           # Main report form
```
...
|-------|---------|----------|
| `frmGLRptBCT01` | `frmReport` | Form báo cáo bảng kê hóa đơn, chứng từ hàng hóa, dịch vụ mua vào |
...
- "Bảng kê hóa đơn, chứng từ hàng hóa, dịch vụ mua vào" - Tên chức năng chính
- "Thuế suất" - Tỷ lệ thuế GTGT
- "Tài khoản thuế" - TK thuế GTGT được khấu trừ
...
- "BangKeThueVao_Thang{Month}_Nam_{Year}.xls" - Pattern file export
- Template: `uTaIn.xls` - Mẫu Excel HTKK cho thuế đầu vào

---

## Mục đích sử dụng

**GLRptBCT01.dll là module báo cáo "Bảng kê hóa đơn, chứng từ hàng hóa, dịch vụ mua vào"** trong hệ thống ERP của Asia Software Development JSC.
...
- Liệt kê hóa đơn mua hàng hóa, dịch vụ
- Phân loại theo thuế suất
- Tính toán thuế GTGT được khấu trừ
- Hỗ trợ đa tiền tệ (VND/Ngoại tệ)

#### 3. Export Excel HTKK
- Xuất dữ liệu sang Excel theo mẫu HTKK (Hỗ trợ kê khai thuế)
- Template: `uTaIn.xls`
- File output: `BangKeThueVao_Thang{X}_Nam_{YYYY}.xls`
...
Đây là module báo cáo thuế GTGT đầu vào trong hệ thống ERP Asia Enterprise, phục vụ cho việc kê khai thuế GTGT theo quy định của Tổng cục Thuế Việt Nam. Module hỗ trợ export dữ liệu sang Excel theo mẫu HTKK để nộp thuế.
