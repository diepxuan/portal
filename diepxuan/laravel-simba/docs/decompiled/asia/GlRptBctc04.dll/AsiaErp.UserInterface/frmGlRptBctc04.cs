...
[DesignerGenerated]
public class frmGlRptBctc04 : frmReport
{
	...
	public frmGlRptBctc04(string menuid)
		: base(menuid)
	{
		__ENCAddToList(this);
		InitializeComponent();
