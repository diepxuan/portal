...
[DesignerGenerated]
public class frmGLMAUBCTCTMV14Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV14Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV14Edit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(261, 252);
		...
		Label obj10 = lblTK;
		location = new Point(197, 170);
		((Control)obj10).Location = location;
		((Control)lblTK).Name = "lblTK";
		Label obj11 = lblTK;
		size = new Size(410, 20);
		((Control)obj11).Size = size;
		((Control)lblTK).TabIndex = 199;
		...
		((Control)Label9).TabIndex = 220;
		Label9.Text = "Loại dư CK";
	...
	private void frmGLMAUBCTCTMV14Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
