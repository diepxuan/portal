# Báo cáo Phân tích DLL: FARptBCPT02.dll
...
| GUID | 1e3a8860-5778-45ed-99a8-a0910e152cfe |
| ComVisible | false |
...
```
FARptBCPT02.dll/
├── FARptBCPT02.csproj           # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   └── frmFARptBCPT02.cs        # Main report form
...
|-------|---------|----------|
| `frmFARptBCPT02` | `frmReport` | Form báo cáo phân tích tài sản 02 |
...
**FARptBCPT02.dll là module báo cáo phân tích tài sản 02** trong hệ thống ERP của Asia Software Development JSC.
...
Đây là module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc x