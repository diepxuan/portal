...
[DesignerGenerated]
public class frmARRptBK02 : frmReport
{
	...
	public frmARRptBK02(string MenuId)
		: base(MenuId)
	{
		lock (__ENCList)
		{
	...
	private void InitializeComponent()
	{
		...
		cboChi_xem.Items.AddRange(new object[3] { "Chưa tất toán", "Tất toán", "Tất cả" });
	...
	protected override bool LoadData()
	{
		...
		checked
		{
			arrayList.Add((cboChi_xem.SelectedIndex + 1).ToString());
			...
			cboKyBc.SelectedIndex = Conversions.ToDate(txtNgay_Ss.Value).Month - 1;
			return true;
		}
	}
