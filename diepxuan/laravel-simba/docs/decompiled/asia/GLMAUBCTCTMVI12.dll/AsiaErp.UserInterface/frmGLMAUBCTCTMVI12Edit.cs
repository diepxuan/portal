...
[DesignerGenerated]
public class frmGLMAUBCTCTMVI12Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMVI12Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMVI12Edit_Load;
		__ENCAddToList(this);
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(255, 202);
		...
		size = new Size(643, 276);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMV12Edit";
	...
	private void frmGLMAUBCTCTMVI12Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
