...
public class frmPORptF5TH0 : frmDrilldownReport
{
	...
	public frmPORptF5TH0(ReportInformation motherReportInfo, string drilldown_menuid, AsDictionary formularFields, bool isNT, string nhan_in, string filter4Tilte, string formatedColList, ref object datasource, params object[] arg)
