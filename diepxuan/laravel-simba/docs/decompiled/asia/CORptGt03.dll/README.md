# Báo cáo Phân tích DLL: CORptGt03.dll
...
```
CORptGt03.dll/
├── CORptGt03.csproj           # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
└── AsiaErp.UserInterface/
    └── frmCORptGt03.cs        # Main form - Báo cáo giá thành 03
```
...
|-------|---------|----------|
| `frmCORptGt03` | `frmReport` | Form báo cáo Giá thành 03 |

---

## Chi tiết Forms

### frmCORptGt03 (Report Form)
- **Kế thừa**: `frmReport`
- **Chức năng**: Báo cáo Giá thành 03
- **Controls chính**:
...
- "Báo cáo giá thành 03" - Tên báo cáo cụ thể
...
| RptGt03 | Report Giá thành 03 |

---

## Mục đích sử dụng

**CORptGt03.dll là module báo cáo "Giá thành 03"** trong hệ thống ERP của Asia Software Development JSC.
...
## So sánh với CORptGt01, CORptGt02
...
| Cấu trúc | Giống nhau | Giống nhau | Giống nhau |

### Phân tích
- CORptGt03 có cấu trúc giống CORptGt02 (hiển thị tên SPCT)
- Cả 3 báo cáo đều có cùng GUID (2b77c71e-b8d4-4512-9c4a-843e2824a429)
- Có thể là 3 định dạng báo cáo khác nhau cho cùng loại dữ liệu
- Khác nhau ở cách trình bày và độ chi tiết của báo cáo

---

## Kết luận

Đây là module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc xuất báo cáo giá thành 03 - một trong 3 định dạng báo cáo phân tích chi phí sản xuất theo sản phẩm chi tiết.
