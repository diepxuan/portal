...
[DesignerGenerated]
public class frmApVchAP4 : frmVoucher
{
	...
	public frmApVchAP4(string menuid)
		: base(menuid)
	{
		__ENCAddToList(this);
		f_sPs_no_header = "";
	...
	public frmApVchAP4(string MenuID, string Stt_rec)
		: base(MenuID, Stt_rec)
	{
		__ENCAddToList(this);
		f_sPs_no_header = "";
	...
	private void InitializeComponent()
	{
		...
		DMNTInformationBindingSource = new BindingSource();
		...
		((Control)this).Name = "frmApVchAP4";
		((Form)this).Text = "frmApVchAP4";
			...
			if (base.ValidData())
			{
				...
				while (true)
				{
					...
					if (Operators.ConditionalCompareObjectNotEqual(Helper.Repl_Null(AsiaErp.Framework.Environment.GetSIConfiguration().canh_bao_dieu_chinh, isNum: false), (object)"0", false))
					{
						...
						if ((Operators.ConditionalCompareObjectNotEqual(Helper.Repl_Null(RuntimeHelpers.GetObjectValue(dataRowView["ma_nt"]), isNum: true), (object)AsiaErp.Framework.Environment.GetSIConfiguration().ma_nt0, false) && Operators.ConditionalCompareObjectNotEqual(txtTy_gia.Value, (object)0, false)) ? true : false)
						{
							double num7 = 0.0;
							double num8 = 0.0;
							Type? typeFromHandle = typeof(Math);
