...
public class MsSqlSOND51mchhdDAO : MsSqlDAO, SOND51mchhdDAO
{
	[DebuggerNonUserCode]
	public MsSqlSOND51mchhdDAO()
	{
	}
	...
	DataTable SOND51mchhdDAO.GetData(string ma_tb)
	{
	...
	DataTable SOND51mchhdDAO.GetData(string ngay1, string ngay2)
	{
		//ILSpy generated this explicit interface implementation from .override directive in GetData
		return this.GetData(ngay1, ngay2);
	}

	public int Insert(string ma_tb, string ma_chung, string ma_loai, string mau_so, string so_seri, string tu_so, string den_so, string so_luong, string lien_hd, string ghi_chu)
	{
	...
	int SOND51mchhdDAO.Insert(string ma_tb, string ma_chung, string ma_loai, string mau_so, string so_seri, string tu_so, string den_so, string so_luong, string lien_hd, string ghi_chu)
	{
		//ILSpy generated this explicit interface implementation from .override directive in Insert
		return this.Insert(ma_tb, ma_chung, ma_loai, mau_so, so_seri, tu_so, den_so, so_luong, lien_hd, ghi_chu);
	}
	...
	int SOND51mchhdDAO.Delete(string ma_tb)
	{
