...
[DesignerGenerated]
public class frmINDMLO : frmDMView
{
	...
	public frmINDMLO(string menuid)
		: base(menuid)
	{
		__ENCAddToList(this);
		InitializeComponent();
	...
	private void InitializeComponent()
	{
		...
		location = new Point(219, 397);
		((Control)obj6).Location = location;
		Button obj7 = cmdAdd;
		location = new Point(331, 397);
