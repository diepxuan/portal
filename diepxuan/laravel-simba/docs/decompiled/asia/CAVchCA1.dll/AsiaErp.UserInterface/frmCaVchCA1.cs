...
[DesignerGenerated]
public class frmCaVchCA1 : frmVoucher
{
	...
	[AccessedThroughProperty("dgvcTy_gia_gs")]
	private DataGridViewAsTextNumericColumn _dgvcTy_gia_gs;
	...
	private virtual Label lblNgay_Lct
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual DataGridViewAsTextNumericColumn dgvcTy_gia_gs
	{
		[DebuggerNonUserCode]
		get
		{
			return _dgvcTy_gia_gs;
		}
		[MethodImpl(MethodImplOptions.Synchronized)]
		[DebuggerNonUserCode]
		set
		{
			_dgvcTy_gia_gs = value;
		}
	}
	...
	public frmCaVchCA1(string menuid)
		: base(menuid)
	{
		__ENCAddToList(this);
	...
	public frmCaVchCA1(string MenuID, string Stt_rec)
		: base(MenuID, Stt_rec)
	{
		__ENCAddToList(this);
		f_sPs_co_header = "Ps_co";
	...
	private void InitializeComponent()
	{
		...
		dgvcTy_gia_gs = new DataGridViewAsTextNumericColumn();
		...
		Button obj = cmdAdd;
		Point location = new Point(9, 413);
		((Control)obj).Location = location;
		Button obj2 = cmdPrint;
		location = new Point(79, 413);
		((Control)obj2).Location = location;
		Button obj3 = cmdLast;
		location = new Point(680, 413);
		((Control)obj3).Location = location;
		Button obj4 = cmdNext;
		location = new Point(657, 413);
		((Control)obj4).Location = location;
		Button obj5 = cmdPrevious;
		location = new Point(634, 413);
		((Control)obj5).Location = location;
		Button obj6 = cmdFirst;
		location = new Point(611, 413);
		((Control)obj6).Location = location;
		((Control)lblSo_Ct).Anchor = (AnchorStyles)5;
		Label obj7 = lblSo_Ct;
		location = new Point(500, 44);
		...
		((DataGridViewColumn)dgvcTy_gia_gs).DataPropertyName = "ty_gia_gs";
		val5.Alignment = (DataGridViewContentAlignment)64;
		val5.Format = "### ###.##";
		((DataGridViewColumn)dgvcTy_gia_gs).DefaultCellStyle = val5;
		((DataGridViewColumn)dgvcTy_gia_gs).HeaderText = "Tỷ giá gs";
		dgvcTy_gia_gs.Mask = "### ###.##";
		((DataGridViewColumn)dgvcTy_gia_gs).Name = "dgvcTy_gia_gs";
		dgvcTy_gia_gs.SortMode = (DataGridViewColumnSortMode)0;
		((DataGridViewColumn)dgvcTy_gia_gs).Visible = false;
		((DataGridViewColumn)dgvcTy_gia_gs).Width = 60;
		...
		((DataGridViewColumn)dgvcMa_ku).Width = 70;
		...
		val12.Format = "### ### ### ###";
		((DataGridViewColumn)dgvcDu13).DefaultCellStyle = val12;
		...
		((Control)this).Name = "frmCaVchCA1";
		((Form)this).Text = "frmCA1Input";
	...
	{
		if ((((DataGridView)adgvDetail).RowCount == 1 && Operators.ConditionalCompareObjectEqual(Helper.Repl_Null(RuntimeHelpers.GetObjectValue(((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcDien_giai).Name, 0].Value), isNum: false), (object)"", false) && !((Control)this).Disposing) ? true : false)
		{
	...
	{
		if ((CTTable != null && e.RowIndex >= 0 && !base.IsLoading && !((Control)this).Disposing) || 1 == 0)
		{
			bool flag = true;
	...
	protected override bool ValidData()
	{
		...
		checked
		{
			if ((base.ValidData() && (ChkEmtyTextBox((TextBox)(object)txtTk_No) & ChkEmtyTextBox((TextBox)(object)txtMa_Kh))) ? true : false)
			{
				bool flag3 = true;
				...
				while (true)
				{
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcTk).Name, num2].ErrorText = Helper.GetMessContent(50002);
						if (flag3)
						{
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcTk).Name, num2].ErrorText = "";
					}
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcTk).Name, num2].ErrorText = Helper.GetMessContent(50092);
						if (flag3)
						{
							((Control)adgvDetail).Select();
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcMa_kh).Name, num2].ErrorText = "";
					}
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcPs_co_nt).Name, num2].ErrorText = Helper.GetMessContent(50002);
						if (flag3)
						{
							((Control)adgvDetail).Select();
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcPs_co_nt).Name, num2].ErrorText = "";
					}
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcPs_co).Name, num2].ErrorText = Helper.GetMessContent(50002);
						if (flag3)
						{
							((Control)adgvDetail).Select();
					...
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcPs_co).Name, num2].ErrorText = "";
					}
					if ((Operators.ConditionalCompareObjectEqual(Helper.Repl_Null(RuntimeHelpers.GetObjectValue(dataRowView["Tk_Cn"]), isNum: false), (object)"1", false) && Operators.ConditionalCompareObjectEqual(Helper.Repl_Null(RuntimeHelpers.GetObjectValue(dataRowView["Ma_Kh"]), isNum: false), (object)"", false)) ? true : false)
					{
						((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcMa_kh).Name, num2].ErrorText = Helper.GetMessContent(50092);
						if (flag3)
						{
							((Control)adgvDetail).Select();
							((DataGridView)adgvDetail).CurrentCell = ((DataGridView)adgvDetail)[((DataGridViewColumn)dgvcMa_kh).Name, num2];
					...
					{
						bool flag4 = (Operators.ConditionalCompareObjectEqual(Helper.Repl_Null(AsiaErp.Framework.Environment.GetSIConfiguration().canh_bao_dieu_chinh, isNum: false), (object)"1", false) ? true : false);
				...
				if (!flag3)
				{
					SetInfoStatusBar(Helper.GetMessContent(50018), Color.Red);
				}
				return flag3;
			}
			return false;
