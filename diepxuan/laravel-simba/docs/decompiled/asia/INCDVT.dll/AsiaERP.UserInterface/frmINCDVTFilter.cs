...
[DesignerGenerated]
public class frmINCDVTFilter : frmOBFilter
{
	...
	private void InitializeComponent()
	{
		...
		((Control)gbLine).Controls.Add((Control)(object)txtMa_tkvt);
		...
		((Control)gbLine).Controls.SetChildIndex((Control)(object)txtMa_tkvt, 0);
		...
		size = new Size(495, 179);
		((Form)this).ClientSize = size;
		((Form)this).MinimizeBox = false;
		((Control)this).Name = "frmINCDVTFilter";
