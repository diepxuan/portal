# Báo cáo Phân tích DLL: GlRptBCT05.dll
...
```
GlRptBCT05.dll/
├── GlRptBCT05.csproj               # Project file
├── app.ico                         # Application icon
├── Properties/
│   └── AssemblyInfo.cs             # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGlRptBCT05.cs            # Main report form
│   ├── frmGLMauCF01.cs             # Form mẫu công thức 01
│   └── frmTATNDN03Edit.cs          # Edit form
├── AsiaErp.DataAccess/
│   ├── IGlRptBCT05.cs              # Interface data access
│   └── MsSqlGlRptBCT05.cs          # SQL Server implementation
└── My/
    ├── MySettings.cs
...
|-------|---------|----------|
| `frmGlRptBCT05` | `frmReport` | Form báo cáo lưu chuyển tiền tệ |
| `frmGLMauCF01` | - | Form mẫu công thức |
| `frmTATNDN03Edit` | - | Form chỉnh sửa |
| `IGlRptBCT05` | - | Interface data access |
| `MsSqlGlRptBCT05` | - | SQL Server DAO implementation |
...
**GlRptBCT05.dll là module báo cáo "Lưu chuyển tiền tệ theo phương pháp trực tiếp"** (Direct Method Cash Flow Statement) - phiên bản thứ 5 trong hệ thống ERP Asia Enterprise.
...
- Interface `IGlRptBCT05` với method `UpdateDataCell`
...
- Tầng Data Access với Interface `IGlRptBCT05`
- Tính toán công thức động qua `DataTable.Compute`
- Override property `dgvBC` để attach events
...
Đây là module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc lập báo cáo Lưu chuyển tiền tệ theo phương pháp trực tiếp. Đây là phiên bản thứ 5 của báo cáo này, có thể là phiên bản cải tiến hoặc dành cho một mẫu báo cáo cụ thể.
