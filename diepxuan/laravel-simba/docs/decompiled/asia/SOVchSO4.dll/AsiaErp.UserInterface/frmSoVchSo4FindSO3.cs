...
[DesignerGenerated]
public class frmSoVchSo4FindSO3 : frmAsiaRoot
{
	...
	[AccessedThroughProperty("txtSo_hd2")]
	private TextBox _txtSo_hd2;

	[AccessedThroughProperty("txtSo_hd1")]
	private TextBox _txtSo_hd1;
	...
	[AccessedThroughProperty("txtNgay_hd2")]
	private AsMaskedTextBox _txtNgay_hd2;

	[AccessedThroughProperty("Label3")]
	private Label _Label3;

	[AccessedThroughProperty("txtNgay_hd1")]
	private AsMaskedTextBox _txtNgay_hd1;
	...
	[AccessedThroughProperty("lblTen_Tk_pt")]
	private Label _lblTen_Tk_pt;
	...
	internal virtual TextBox txtSo_hd2
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual TextBox txtSo_hd1
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual AsMaskedTextBox txtNgay_hd2
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual AsMaskedTextBox txtNgay_hd1
	{
		[DebuggerNonUserCode]
		get
		{
	...
	internal virtual Label lblTen_Tk_pt
	{
		[DebuggerNonUserCode]
		get
		{
			return _lblTen_Tk_pt;
		}
		[MethodImpl(MethodImplOptions.Synchronized)]
		[DebuggerNonUserCode]
		set
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmSoVchSo4FindSO3));
		cmdCancel = new Button();
		cmdOk = new Button();
		txtSo_hd2 = new TextBox();
		txtSo_hd1 = new TextBox();
		Label1 = new Label();
		Label2 = new Label();
		txtNgay_hd2 = new AsMaskedTextBox();
		Label3 = new Label();
		txtNgay_hd1 = new AsMaskedTextBox();
		Label4 = new Label();
		...
		Point location = new Point(91, 207);
		...
		TextBox obj5 = txtSo_hd2;
		location = new Point(259, 39);
		((Control)obj5).Location = location;
		((Control)txtSo_hd2).Name = "txtSo_hd2";
		TextBox obj6 = txtSo_hd2;
		size = new Size(82, 20);
		((Control)obj6).Size = size;
		((Control)txtSo_hd2).TabIndex = 3;
		TextBox obj7 = txtSo_hd1;
		location = new Point(113, 39);
		((Control)obj7).Location = location;
		((Control)txtSo_hd1).Name = "txtSo_hd1";
		TextBox obj8 = txtSo_hd1;
		size = new Size(82, 20);
		((Control)obj8).Size = size;
		((Control)txtSo_hd1).TabIndex = 2;
		...
		Label2.Text = "Hoá đơn số";
		txtNgay_hd2.Format = "@Ddd/MM/yyyy";
		((MaskedTextBox)txtNgay_hd2).InsertKeyMode = (InsertKeyMode)2;
		AsMaskedTextBox asMaskedTextBox = txtNgay_hd2;
		location = new Point(259, 13);
		((Control)asMaskedTextBox).Location = location;
		((MaskedTextBox)txtNgay_hd2).Mask = "##/##/####";
		((Control)txtNgay_hd2).Name = "txtNgay_hd2";
		((MaskedTextBox)txtNgay_hd2).PromptChar = ' ';
		AsMaskedTextBox asMaskedTextBox2 = txtNgay_hd2;
		size = new Size(82, 20);
		((Control)asMaskedTextBox2).Size = size;
		((Control)txtNgay_hd2).TabIndex = 1;
		((MaskedTextBox)txtNgay_hd2).ValidatingType = typeof(DateTime);
		AsMaskedTextBox asMaskedTextBox3 = txtNgay_hd2;
		DateTime dateTime = new DateTime(1900, 1, 1, 0, 0, 0, 0);
		asMaskedTextBox3.Value = dateTime;
		Label3.AutoSize = true;
		Label label5 = Label3;
		location = new Point(201, 17);
		...
		txtNgay_hd1.Format = "@Ddd/MM/yyyy";
		((MaskedTextBox)txtNgay_hd1).InsertKeyMode = (InsertKeyMode)2;
		AsMaskedTextBox asMaskedTextBox4 = txtNgay_hd1;
		location = new Point(113, 13);
		((Control)asMaskedTextBox4).Location = location;
		((MaskedTextBox)txtNgay_hd1).Mask = "##/##/####";
		((Control)txtNgay_hd1).Name = "txtNgay_hd1";
		((MaskedTextBox)txtNgay_hd1).PromptChar = ' ';
		AsMaskedTextBox asMaskedTextBox5 = txtNgay_hd1;
		size = new Size(82, 20);
		((Control)asMaskedTextBox5).Size = size;
		((Control)txtNgay_hd1).TabIndex = 0;
		((MaskedTextBox)txtNgay_hd1).ValidatingType = typeof(DateTime);
		AsMaskedTextBox asMaskedTextBox6 = txtNgay_hd1;
		...
		lblTen_Tk_pt.ImeMode = (ImeMode)0;
		Label obj17 = lblTen_Tk_pt;
		location = new Point(201, 147);
		((Control)obj17).Location = location;
		((Control)lblTen_Tk_pt).Name = "lblTen_Tk_pt";
		Label obj18 = lblTen_Tk_pt;
		size = new Size(344, 13);
		((Control)obj18).Size = size;
		((Control)lblTen_Tk_pt).TabIndex = 252;
		lblTen_Tk_pt.TextAlign = (ContentAlignment)16;
		((TextBox)txtTk_pt).AutoCompleteSource = (AutoCompleteSource)64;
		txtTk_pt.AutoLookup = true;
		txtTk_pt.AutoValid = false;
		...
		((Control)txtNguoi_Gd).TabIndex = 5;
		...
		((Control)gbCt).Controls.Add((Control)(object)txtNgay_hd1);
		...
		((Control)gbCt).Controls.Add((Control)(object)txtNguoi_Gd);
		...
		((Control)gbCt).Controls.Add((Control)(object)txtNgay_hd2);
		((Control)gbCt).Controls.Add((Control)(object)Label2);
		((Control)gbCt).Controls.Add((Control)(object)lblMa_Hd);
		((Control)gbCt).Controls.Add((Control)(object)lblTk_pt);
		((Control)gbCt).Controls.Add((Control)(object)Label1);
		((Control)gbCt).Controls.Add((Control)(object)txtSo_hd2);
		((Control)gbCt).Controls.Add((Control)(object)lblTen_Tk_pt);
		((Control)gbCt).Controls.Add((Control)(object)txtTk_pt);
		((Control)gbCt).Controls.Add((Control)(object)txtSo_hd1);
		GroupBox obj25 = gbCt;
		location = new Point(10, 3);
		((Control)obj25).Location = location;
		((Control)gbCt).Name = "gbCt";
		GroupBox obj26 = gbCt;
		size = new Size(570, 198);
		...
		((Control)lblTen_Kh).TabIndex = 273;
		...
		((Control)this).Name = "frmSoVchSo4FindSO3";
		((Form)this).Text = "Loc Hoa Don";
	...
	private void cmdOk_Click(object sender, EventArgs e)
	{
		...
		{
			sWhereKey = sWhereKey + " and ma_kh like '" + ((TextBox)txtMa_Kh).Text + "%'";
		}
		if (Operators.ConditionalCompareObjectNotEqual(txtNgay_hd1.Value, (object)new DateTime(599266080000000000L), false))
		{
			string text = sWhereKey;
			DateTime dateTime = (DateTime)txtNgay_hd1.Value;
			sWhereKey = text + " and Ngay_ct>= '" + dateTime.ToString("MM/dd/yyyy") + "'";
		}
		if (Operators.ConditionalCompareObjectNotEqual(txtNgay_hd2.Value, (object)new DateTime(599266080000000000L), false))
		{
			string text2 = sWhereKey;
			DateTime dateTime = (DateTime)txtNgay_hd2.Value;
			sWhereKey = text2 + " and Ngay_ct <= '" + dateTime.ToString("MM/dd/yyyy") + "'";
		}
		if (Operators.CompareString(txtSo_hd1.Text, "", false) != 0)
		{
			sWhereKey = sWhereKey + " and So_ct>= '" + txtSo_hd1.Text + "'";
		}
		if (Operators.CompareString(txtSo_hd2.Text, "", false) != 0)
		{
			sWhereKey = sWhereKey + " and So_ct<= '" + txtSo_hd2.Text + "'";
		}
		if (Operators.CompareString(((TextBox)txtTk_pt).Text, "", false) != 0)
		{
			sWhereKey = sWhereKey + " and tk_pt like '" + ((TextBox)txtTk_pt).Text + "'";
		}
		...
		{
			sWhereKey = sWhereKey + " and Nguoi_Gd like '" + txtNguoi_Gd.Text + "%'";
		}
		if (Operators.CompareString(txtDien_giai.Text, "", false) != 0)
		{
			sWhereKey = sWhereKey + " and dien_giai like '%" + txtDien_giai.Text + "%'";
		}
		AsiaErp.Framework.Environment.set_PublicVariables("Ngay_Ct1", RuntimeHelpers.GetObjectValue(txtNgay_hd1.Value));
		AsiaErp.Framework.Environment.set_PublicVariables("Ngay_Ct2", RuntimeHelpers.GetObjectValue(txtNgay_hd2.Value));
		((Form)this).Close();
	}
