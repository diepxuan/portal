...
[DesignerGenerated]
public class frmGLMAUBCTCTMV01Edit : frmDMComplexEdit
{
	...
	[DebuggerNonUserCode]
	public frmGLMAUBCTCTMV01Edit()
	{
		((Form)this).Load += frmGLMAUBCTCTMV01Edit_Load;
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(257, 257);
		...
		size = new Size(647, 329);
		((Form)this).ClientSize = size;
		((Control)this).Controls.Add((Control)(object)txtMauQD);
		((Control)this).Name = "frmGLMAUBCTCTMV01Edit";
	...
	private void frmGLMAUBCTCTMV01Edit_Load(object sender, EventArgs e)
	{
		if (!EditMode)
		{
