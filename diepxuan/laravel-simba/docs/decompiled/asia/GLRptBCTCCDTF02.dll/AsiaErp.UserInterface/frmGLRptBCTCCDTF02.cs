...
[DesignerGenerated]
public class frmGLRptBCTCCDTF02 : frmReport
{
	...
	[AccessedThroughProperty("lblTen_Ma_SPCT")]
	private Label _lblTen_Ma_SPCT;
	...
	internal virtual Label lblTen_Ma_SPCT
	{
		[DebuggerNonUserCode]
		get
		{
			return _lblTen_Ma_SPCT;
		}
		[MethodImpl(MethodImplOptions.Synchronized)]
		[DebuggerNonUserCode]
		set
		{
			_lblTen_Ma_SPCT = value;
		}
	}
	...
	public frmGLRptBCTCCDTF02(string menuid)
		: base(menuid)
	{
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		((Control)tabFilter).Controls.Add((Control)(object)lblTen_Ma_SPCT);
		...
		((Control)tabFilter).Controls.SetChildIndex((Control)(object)lblTen_Ma_SPCT, 0);
		...
		txtMa_SPCT.NameControl = lblTen_Ma_SPCT;
		...
		Label obj18 = lblTen_Ma_SPCT;
		location = new Point(232, 131);
		((Control)obj18).Location = location;
		((Control)lblTen_Ma_SPCT).Name = "lblTen_Ma_SPCT";
		Label obj19 = lblTen_Ma_SPCT;
		size = new Size(300, 20);
		((Control)obj19).Size = size;
		((Control)lblTen_Ma_SPCT).TabIndex = 1108;
		...
		((Control)lblMa_SPCT).TabIndex = 1107;
		...
		((Control)this).Name = "frmGLRptBCTCCDTF02";
		((Form)this).Text = "frmGLRptBCTCCDTF02";
