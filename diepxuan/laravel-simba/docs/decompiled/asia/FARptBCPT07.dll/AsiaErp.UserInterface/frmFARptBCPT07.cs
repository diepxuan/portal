...
[DesignerGenerated]
public class frmFARptBCPT07 : frmReport
{
	...
	public frmFARptBCPT07(ref string MenuId)
		: base(MenuId)
	{
		lock (__ENCList)
		{
	...
	private void InitializeComponent()
	{
		...
		((Control)lblTen_BPSD).TabIndex = 9;
		lblMa_BPSD.AutoSize = true;
		Label obj18 = lblMa_BPSD;
		...
		((Control)lblMa_BPSD).TabIndex = 1339;
		...
		((Control)lblTen_Phi).TabIndex = 1338;
		lblMa_Phi.AutoSize = true;
		Label obj22 = lblMa_Phi;
		...
		((Control)lblMa_Phi).TabIndex = 1337;
		...
		((Control)lblMa_SPCT).TabIndex = 1335;
		...
		((Control)lblTen_SPCT).TabIndex = 1336;
		SizeF autoScaleDimensions = new SizeF(6f, 13f);
		((ContainerControl)this).AutoScaleDimensions = autoScaleDimensions;
		size = new Size(572, 282);
		((Form)this).ClientSize = size;
		((Control)this).Name = "frmFARptBCPT07";
