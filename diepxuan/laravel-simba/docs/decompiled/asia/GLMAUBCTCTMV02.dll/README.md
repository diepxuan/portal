# Báo cáo Phân tích DLL: GLMAUBCTCTMV02.dll
...
```
GLMAUBCTCTMV02.dll/
├── GLMAUBCTCTMV02.csproj        # Project file
├── app.ico                        # Application icon
├── Properties/
│   └── AssemblyInfo.cs            # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMV02.cs         # Main view form
│   └── frmGLMAUBCTCTMV02Edit.cs     # Edit form
...
|-------|---------|----------|
| `frmGLMAUBCTCTMV02` | `frmDMComplexView` | Form xem danh sách mẫu báo cáo tài chính V02 |
| `frmGLMAUBCTCTMV02Edit` | `frmDMComplexEdit` | Form chỉnh sửa chỉ tiêu báo cáo tài chính V02 |
...
| Event | Handler | Mô tả |
|-------|---------|---------|
| Load | frmGLMAUBCTCTMV02Edit_Load | Set default IsPrint = true khi thêm mới |

---

## Mục đích sử dụng

**GLMAUBCTCTMV02.dll là module quản lý Mẫu báo cáo tài chính V02** trong hệ thống ERP của Asia Software Development JSC.
...
**BCTC V02** - Báo cáo tài chính V02 (theo Thông tư 200/2014/TT-BTC hoặc QĐ 15/2006/QĐ-BTC)

---

## Kết luận

Đây là một module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc cấu hình và quản lý mẫu báo cáo tài chính V02 - một báo cáo tài chính quan trọng trong kế toán doanh nghiệp Việt Nam. Module này hỗ trợ cấu hình công thức tính toán và liên kết với tài khoản kế toán.
