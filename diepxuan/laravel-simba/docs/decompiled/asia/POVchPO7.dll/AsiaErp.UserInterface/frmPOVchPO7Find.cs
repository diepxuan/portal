...
[DesignerGenerated]
public class frmPOVchPO7Find : frmVoucherFind
{
	...
	private void InitializeComponent()
	{
		...
		Point location = new Point(93, 456);
		...
		AsTextBox asTextBox15 = txtMa_Lo;
		location = new Point(153, 42);
		...
		AsTextBox asTextBox16 = txtMa_Lo;
		size = new Size(95, 20);
		...
		((Control)lblTen_httt).TabIndex = 290;
		...
		((Control)lblMa_httt).TabIndex = 289;
		...
		AsTextBox asTextBox19 = txtMa_Bp;
		location = new Point(153, 146);
