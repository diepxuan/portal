# Báo cáo Phân tích DLL: GLMAUBCTCTMVII.dll
...
| Thuộc tính | Giá trị |
|------------|---------|
| Assembly Name | GLMAUBCTCTMVII |
| Assembly Title | GLBCTC07VI |
| Assembly Product | GLBCTC07VI |
| Assembly Copyright | Copyright © 2012 |
| Assembly Version | 1.0.0.0 |
| Assembly File Version | 1.0.0.0 |
| GUID | fb133ae2-ca9c-443c-becc-6606b1d82f20 |
| ComVisible | false |
...
```
GLMAUBCTCTMVII.dll/
├── GLMAUBCTCTMVII.csproj        # Project file
├── app.ico                      # Application icon
├── Properties/
│   └── AssemblyInfo.cs          # Assembly metadata
├── AsiaErp.UserInterface/
│   ├── frmGLMAUBCTCTMVII.cs     # Main form class
│   └── frmGLMAUBCTCTMVIIEdit.cs # Edit form
...
|-------|---------|----------|
| `frmGLMAUBCTCTMVII` | `frmDMComplexView` | Form xem danh sách mẫu báo cáo tài chính II |
| `frmGLMAUBCTCTMVIIEdit` | `frmDMComplexEdit` | Form chỉnh sửa chỉ tiêu báo cáo tài chính II |
...
**GLMAUBCTCTMVII.dll là module quản lý mẫu báo cáo tài chính II** trong hệ thống ERP của Asia Software Development JSC.

### Chức năng chính

#### 1. Quản lý chỉ tiêu báo cáo tài chính II
...
Đây là một module Windows Forms của hệ thống ERP Asia Enterprise, phục vụ cho việc cấu hình và quản lý mẫu báo cáo tài chính II - một loại báo cáo tài chính theo quy định của Bộ Tài chính Việt Nam.
