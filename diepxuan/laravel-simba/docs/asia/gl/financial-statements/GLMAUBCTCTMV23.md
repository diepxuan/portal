...
### Controller
```php
class GLMAUBCTCTMV23Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV23Repository
{
...
### Model
```php
class GLMAUBCTCTMV23 extends Model
{
