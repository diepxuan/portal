...
- **Loai bao cao**: Bao cao tai chinh - Mau V (Theo thong tu 200/2014/TT-BTC)
- **Dac diem**: 1 tai khoan, cong trinh

## Forms

### frmGLMAUBCTCTMV11.cs
- **Ke thua**: frmDMComplexView
- **Chuc nang**: Hien thi danh sach cac chi tieu bao cao

### frmGLMAUBCTCTMV11Edit.cs
...
| txtTaikhoan | AsTextBox | tk_01 | - |
| lblTK | Label | - | - |
| txtCongTrinh | AsTextBox | ma_spct | - |
| lblCongTrinh | Label | - | - |
...
### Controller
```php
class GLMAUBCTCTMV11Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV11Repository
{
...
### Model
```php
class GLMAUBCTCTMV11 extends Model
{
