...
### Controller
```php
class GLMAUBCTCTMVI02aController extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMVI02aRepository
{
...
### Model
```php
class GLMAUBCTCTMVI02a extends Model
{
