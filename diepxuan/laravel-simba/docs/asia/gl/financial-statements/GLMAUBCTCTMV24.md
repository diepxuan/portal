...
### Controller
```php
class GLMAUBCTCTMV24Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV24Repository
{
...
### Model
```php
class GLMAUBCTCTMV24 extends Model
{
