...
### Controller
```php
class GLMAUBCTCTMV12Controller extends Controller
{
...
### Repository
```php
class GLMAUBCTCTMV12Repository
{
...
### Model
```php
class GLMAUBCTCTMV12 extends Model
{
