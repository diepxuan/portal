# FARptBCPT05.dll - Phân tích chi tiết

## 1. Thông tin chung

| Thuộc tính | Giá trị |
|------------|---------|
| **DLL Name** | FARptBCPT05.dll |
| **Form Class** | frmFARptBCPT05 |
| **Namespace** | AsiaErp.UserInterface |
| **Inheritance** | frmReport |
| **Module** | Fixed Assets (FA) - Báo cáo phân tích tài sản 05 |
...
|---------|---------|------------|
| sp_FARptBCPT05_GetData | Lấy dữ liệu báo cáo | @Ma_cty, @Ngay1, @Ngay2, @Ma_bpsd, @Ma_phi, @Ma_spct |
...
class BCPT05Controller extends Controller
{
    public function index()
    {
        ...
        return view('fa.reports.bcpt05', compact('groupOptions'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        $data = DB::select('EXEC sp_FARptBCPT05_GetData ?, ?, ?, ?, ?, ?', $params);
...
- Có thể là tính năng chuẩn bị cho tương lai
