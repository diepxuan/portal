...
{
    /**
     * Call stored procedure asSORptBCPT021
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSORptBCPT021', [
    ...
    /**
     * Call stored procedure asSORptBCPT021 with named parameters
     *
     * @param string $Ma_cty
     * @param string $ngay1
     * @param string $Ngay2
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $ngay1 = null, string $Ngay2 = null, string $Soct1 = null, string $Soct2 = null, string $Ma_kh = null, string $Ma_nhkh = null, string $Ma_plkh1 = null, string $Ma_plkh2 = null, string $Ma_plkh3 = null, string $Ma_hd = null, string $Ma_nhhd = null, string $Ma_NT = null, string $Ma_vt = null, string $Ma_nhvt = null, string $Ma_plvt1 = null, string $Ma_plvt2 = null, string $Ma_plvt3 = null, string $Ma_bp = null, string $Ma_nvkd = null, string $Ma_TT = null, string $Status = null, mixed $Ngay1 = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pngay1' => $ngay1,
