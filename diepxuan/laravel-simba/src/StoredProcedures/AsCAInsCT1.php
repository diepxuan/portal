 ...
 * Class AsCAInsCT1.
 *
 * Stored procedure: asCAInsCT1
 * Mục đích: Thêm mới dòng chi tiết thứ 1 cho phiếu thu/chi (bảng CACT1 - Cash Chi Tiết 1).
 * Procedure thực hiện insert bản ghi mới vào bảng CACT1 với thông tin chi tiết phân bổ chi phí.
 *
 ...
 *     'pPs_no_nt' => 142000000,
 *     'pPs_co_nt' => 0,
 *     'pDien_giai' => 'Thanh toán theo HD001',
 *     'pMa_kh' => 'CCNHUNGGOI',
 *     'pMa_bp' => 'BP001',
 *     'pLUser' => 'DUCTN',
 * ]);
...
{
    /**
     * Gọi stored procedure asCAInsCT1.
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asCAInsCT1', [
    ...
    /**
     * Call stored procedure asCAInsCT1 with named parameters (helper method).
     *
