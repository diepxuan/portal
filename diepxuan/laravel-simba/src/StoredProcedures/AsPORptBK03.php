...
{
    /**
     * Call stored procedure asPORptBK03
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asPORptBK03', [
    ...
    /**
     * Call stored procedure asPORptBK03 with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ngay1
     * @param string $Ngay2
