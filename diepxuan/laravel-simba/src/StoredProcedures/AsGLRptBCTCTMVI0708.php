 ...
 *
 * Stored procedure: asGLRptBCTCTMVI0708
 ...
 *     @pNgay2 => '',
 * ];
 * $result = AsGLRptBCTCTMVI0708::call($params);
 * ```
 */
class AsGLRptBCTCTMVI0708
{
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asGLRptBCTCTMVI0708', [
            'pMa_cty' => $paramObj->pMa_cty ?? '999',
            'pMau' => $paramObj->pMau ?? '',
            'pNgay1' => $paramObj->pNgay1 ?? '01/01/2014',
            'pNgay2' => $paramObj->pNgay2 ?? '01/31/2014',
        ], $connection);
    }
}
