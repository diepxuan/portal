...
{
    /**
     * Call stored procedure asHrUpdChamCong
     *
    ...
    /**
     * Call stored procedure asHrUpdChamCong with named parameters
     *
     * @param string $Ma_cty
     * @param int $Nam
     * @param int $Thang
