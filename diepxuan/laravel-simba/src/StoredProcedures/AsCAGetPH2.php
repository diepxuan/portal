 ...
 *
 * @lastupdate 2026-04-06 18:46:44
 */
 ...
 * Mục đích: Lấy danh sách phiếu hàng 2 (PH2) từ hệ thống Simba.
 * Procedure trả về danh sách các phiếu hàng loại 2 được sử dụng trong quản lý kho.
 *
 * Tham số:
 * - Không có tham số đầu vào.
 *
 * Giá trị trả về:
 * - Collection chứa danh sách phiếu hàng 2 với các trường thông tin liên quan.
 *
 * Ví dụ gọi:
 * ```php
 * // Sử dụng method call()
