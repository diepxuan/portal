...
class AsHrGetTDHoiDong
{
    /**
     * Call stored procedure asHrGetTDHoiDong
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrGetTDHoiDong', [
    ...
    /**
     * Call stored procedure asHrGetTDHoiDong with named parameters
     *
     * @param string $Ma_cty
