...
class AsHrUpdHSNSPhuCap
{
    /**
     * Call stored procedure asHrUpdHSNSPhuCap
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrUpdHSNSPhuCap', [
    ...
    /**
     * Call stored procedure asHrUpdHSNSPhuCap with named parameters
     *
     * @param string $Ma_cty
     * @param string $Id
     * @param string $Ma
