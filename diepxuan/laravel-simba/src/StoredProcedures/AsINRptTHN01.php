...
{
    /**
     * Call stored procedure asINRptTHN01
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asINRptTHN01', [
    ...
    /**
     * Call stored procedure asINRptTHN01 with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ngay1
     * @param string $Ngay2
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Ngay1 = null, string $Ngay2 = null, string $Ctu1 = null, string $Ctu2 = null, string $Ma_kh = null, string $Ma_NhKH = null, string $Ma_PLKH1 = null, string $Ma_PLKH2 = null, string $Ma_PLKH3 = null, string $Loai_pn = null, string $Loai_gd = null, string $Ma_Hd = null, string $Ma_vt = null, string $Ma_kho = null, string $Ma_vitri = null, string $Ma_bp = null, string $Ma_spct = null, string $TK_VT = null, string $Tk_Du = null, string $Nhom_VT = null, string $PSDC = null, string $Ma_nx = null, string $Ma_lo = null, string $Ma_phi = null, string $Ma_NT = null, string $DVT = null, string $SysMsg1 = null, mixed $Ma_nt = null, mixed $Ma_hd = null, string $ParamDefines = null, string $Group = null, string $Detail = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pNgay1' => $Ngay1,
