 ...
 * Class AsCADelPH1.
 *
 * Stored procedure: asCADelPH1
 * Mục đích: Xóa phiếu thu/chi (bảng CAPH1 - Cash Phiếu 1) theo mã công ty và số tham chiếu.
 * Procedure thực hiện xóa bản ghi khỏi bảng CAPH1 dựa trên số tham chiếu (stt_rec).
 ...
 * - @pMa_cty (nvarchar(3)): Mã công ty. Default: giá trị từ SModel::CTY.
 ...
 *
 * @see AsCAGetPH1::call() - Kiểm tra phiếu tồn tại trước khi xóa
 */
class AsCADelPH1
{
    /**
     * Gọi stored procedure asCADelPH1.
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asCADelPH1', [
    ...
    /**
     * Call stored procedure asCADelPH1 with named parameters (helper method).
     *
