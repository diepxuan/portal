...
class AsHrInsDmNgachBac
{
    /**
     * Call stored procedure asHrInsDmNgachBac
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrInsDmNgachBac', [
    ...
    /**
     * Call stored procedure asHrInsDmNgachBac with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ma_tbl
     * @param string $Ma_nb
