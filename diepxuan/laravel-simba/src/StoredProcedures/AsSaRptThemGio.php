...
class AsSaRptThemGio
{
    /**
     * Call stored procedure asSaRptThemGio
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSaRptThemGio', [
    ...
    /**
     * Call stored procedure asSaRptThemGio with named parameters
     *
     * @param string $Ma_cty
     * @param int $Thang
     * @param int $Nam
