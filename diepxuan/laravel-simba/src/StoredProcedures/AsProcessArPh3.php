...
class AsProcessArPh3
{
    /**
     * Call stored procedure asProcessArPh3
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessArPh3', [
    ...
    /**
     * Call stored procedure asProcessArPh3 with named parameters
     *
     * @param string $Ma_cty
