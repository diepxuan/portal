 ...
 *
 * @lastupdate 2026-04-06 18:46:54
 */
 ...
 * Class AsCAUpdPH2.
 *
 * Stored procedure: asCAUpdPH2
 * Mục đích: Cập nhật phiếu thu/chi 2 (bảng CAPH2).
 * Procedure thực hiện update bản ghi trong bảng CAPH2 với thông tin mới.
 *
...
{
    /**
     * Gọi stored procedure asCAUpdPH2.
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asCAUpdPH2', [
    ...
    /**
     * Call stored procedure asCAUpdPH2 with named parameters (helper method).
     *
