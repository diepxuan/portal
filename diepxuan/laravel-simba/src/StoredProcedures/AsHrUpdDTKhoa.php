...
{
    /**
     * Call stored procedure asHrUpdDTKhoa
     *
    ...
    /**
     * Call stored procedure asHrUpdDTKhoa with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ma_kdt
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Ma_kdt = null, string $Ten_kdt = null, string $Ngay_dk = null, string $Ngay_bd = null, string $Ngay_kt = null, string $Nganh_dt = null, string $Cap_dt = null, string $Noi_dung = null, string $Chung_chi = null, string $Ma_doi_tuong = null, string $Ten_doi_tuong = null, string $Dia_diem_dt = null, int $So_buoi = null, float $Thoi_luong = null, float $Tien_dt = null, float $Tl_dt_cty = null, float $Tien_dt_cty = null, float $Tl_dt_nv = null, float $Tien_dt_nv = null, string $Ket_qua = null, string $Ghi_chu = null, string $Trang_thai = null, string $Tai_lieu = null, string $Luser = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pMa_kdt' => $Ma_kdt,
