 ...
 * Class AsCARptTMNH01.
 *
 * Stored procedure: asCARptTMNH01
 * Mục đích: Báo cáo lưu chuyển tiền tệ mẫu 01 (TMNH01).
 ...
 * - @pTk (nvarchar(20)): Tài khoản. Default '111'.
...
{
    /**
     * Gọi stored procedure asCARptTMNH01.
     *
    ...
    /**
     * Call stored procedure asCARptTMNH01 with named parameters (helper method).
     *
