...
{
    /**
     * Call stored procedure asSOUpdPH3
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSOUpdPH3', [
            ...
            'pNgay_px' => $paramObj->pNgay_px ?? null,
            'pDia_chi_px' => $paramObj->pDia_chi_px ?? null,
            'pNguoi_gd_px' => $paramObj->pNguoi_gd_px ?? null,
            'pTel_px' => $paramObj->pTel_px ?? null,
            'pDien_giai_px' => $paramObj->pDien_giai_px ?? null,
    ...
    /**
     * Call stored procedure asSOUpdPH3 with named parameters
     *
     * @param string $Ma_cty
