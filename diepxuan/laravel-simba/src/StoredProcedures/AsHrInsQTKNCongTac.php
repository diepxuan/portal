...
class AsHrInsQTKNCongTac
{
    /**
     * Call stored procedure asHrInsQTKNCongTac
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrInsQTKNCongTac', [
    ...
    /**
     * Call stored procedure asHrInsQTKNCongTac with named parameters
     *
     * @param string $Ma_cty
     * @param string $Id
