 ...
 *
 * @lastupdate 2026-04-06 07:33:37
 */
 ...
 * - @pStt_rec (nvarchar(20)): Số thứ tự record (stt_rec). Khóa chính của bảng CACT2. Bắt buộc.
 ...
 *
 * @see AsCAGetCT2::call() - Kiểm tra chứng từ tồn tại trước khi xóa
 */
class AsCADelCT2
{
    /**
    ...
    /**
     * Call stored procedure asCADelCT2 with named parameters (helper method).
     *
