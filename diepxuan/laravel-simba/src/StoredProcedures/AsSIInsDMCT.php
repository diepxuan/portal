...
{
    /**
     * Call stored procedure asSIInsDMCT
     *
    ...
    /**
     * Call stored procedure asSIInsDMCT with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ma_ct
