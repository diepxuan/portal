...
class AsProcessCRPh1
{
    /**
     * Call stored procedure asProcessCRPh1
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessCRPh1', [
    ...
    /**
     * Call stored procedure asProcessCRPh1 with named parameters
     *
     * @param string $Ma_cty
