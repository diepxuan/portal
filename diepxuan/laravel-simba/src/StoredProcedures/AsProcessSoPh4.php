...
class AsProcessSoPh4
{
    /**
     * Call stored procedure asProcessSoPh4
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessSoPh4', [
    ...
    /**
     * Call stored procedure asProcessSoPh4 with named parameters
     *
     * @param string $Ma_cty
