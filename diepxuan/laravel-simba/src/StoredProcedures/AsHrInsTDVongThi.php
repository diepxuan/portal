...
{
    /**
     * Call stored procedure asHrInsTDVongThi
     *
    ...
    /**
     * Call stored procedure asHrInsTDVongThi with named parameters
     *
     * @param string $Ma_cty
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Ma_yctd = null, string $Vong_so = null, string $Ten_vong = null, int $So_nguoi_lh = null, int $So_nguoi_tg = null, string $Ghi_chu = null, string $Cuser = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pMa_yctd' => $Ma_yctd,
