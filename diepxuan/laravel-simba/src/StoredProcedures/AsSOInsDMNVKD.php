...
{
    /**
     * Call stored procedure asSOInsDMNVKD
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSOInsDMNVKD', $params, $connection);
    }

    /**
     * Call stored procedure asSOInsDMNVKD with named parameters
     *
     * @param string $Ma_cty
