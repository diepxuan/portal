...
{
    /**
     * Call stored procedure asINInsDMVT
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asINInsDMVT', [
            ...
            'pDvdg' => $paramObj->pDvdg ?? null,
            'pQcdg' => $paramObj->pQcdg ?? null,
    ...
    /**
     * Call stored procedure asINInsDMVT with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ma_vt
     * @param string $Loai
