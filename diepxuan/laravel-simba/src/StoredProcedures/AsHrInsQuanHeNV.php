...
{
    /**
     * Call stored procedure asHrInsQuanHeNV
     *
    ...
    /**
     * Call stored procedure asHrInsQuanHeNV with named parameters
     *
     * @param string $Ma_cty
     * @param string $Id
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Id = null, string $Id_qtqh = null, string $Ho_ten = null, string $Ho_dem = null, string $Ten = null, string $Ngay_sinh = null, string $Gioi_tinh = null, string $Quan_he = null, string $Noi_o = null, string $Noi_o_dc = null, string $Noi_o_xa = null, string $Noi_o_huyen = null, string $Noi_o_tinh = null, string $Ma_ton_giao = null, string $Ma_dan_toc = null, string $Ma_quoc_tich = null, string $Ma_to_chuc = null, string $Ma_cvcm = null, string $Phone_mobile = null, string $Phone_home = null, string $Phone_work = null, string $Phone_work_ext = null, string $Email_home = null, string $Anh_dai_dien = null, string $Tai_lieu = null, bool $Phu_thuoc = null, bool $Khan_cap = null, string $Cuser = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pId' => $Id,
