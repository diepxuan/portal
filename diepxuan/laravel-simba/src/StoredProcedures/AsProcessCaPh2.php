...
class AsProcessCaPh2
{
    /**
     * Call stored procedure asProcessCaPh2
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessCaPh2', [
    ...
    /**
     * Call stored procedure asProcessCaPh2 with named parameters
     *
     * @param string $Ma_cty
