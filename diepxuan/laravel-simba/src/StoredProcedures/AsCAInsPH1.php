 ...
 *
 * @lastupdate 2026-04-06 08:35:04
 */
 ...
 * Class AsCAInsPH1.
 *
 * Stored procedure: asCAInsPH1
 * Mục đích: Thêm mới phiếu 1 (bảng CAPH1 - Cash Phiếu 1).
 * Procedure thực hiện insert bản ghi mới vào bảng CAPH1 với thông tin chứng từ thu/chi tiền mặt (header).
 *
 ...
 * Ví dụ gọi:
 * ```php
 * $result = AsCAInsPH1::call([
 *     'pMa_cty' => '001',
 *     'pStt_rec' => '001wCA30000000676668',
 *     'pMa_ct' => 'CA3',
 *     'pSo_ct' => 'PT02944',
 *     'pNgay_ct' => '2026-02-12',
...
{
    /**
     * Gọi stored procedure asCAInsPH1.
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asCAInsPH1', [
    ...
    /**
     * Call stored procedure asCAInsPH1 with named parameters (helper method).
     *
