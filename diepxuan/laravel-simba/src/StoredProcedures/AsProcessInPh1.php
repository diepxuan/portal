...
class AsProcessInPh1
{
    /**
     * Call stored procedure asProcessInPh1
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessInPh1', [
    ...
    /**
     * Call stored procedure asProcessInPh1 with named parameters
     *
     * @param string $Ma_cty
