...
class AsProcessPoPh3
{
    /**
     * Call stored procedure asProcessPoPh3
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessPoPh3', [
    ...
    /**
     * Call stored procedure asProcessPoPh3 with named parameters
     *
     * @param string $Ma_cty
