...
{
    /**
     * Call stored procedure asUpdreportinfo
     *
    ...
    /**
     * Call stored procedure asUpdreportinfo with named parameters
     *
     ...
     * @return Collection
     */
    public static function callWithParams(string $Key_Menuid = null, string $Key_Ma_mau = null, string $Menuid = null, string $Ma_mau = null, string $Ctlclass = null, string $Spname = null, string $Rptname = null, bool $Isdefault = null, string $Bang_chu = null, string $Bang_chu0 = null, string $DynReportFields = null, bool $HasNT = null, int $Ret = null): Collection
    {
        $params = [
