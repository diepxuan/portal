 ...
 * 
 * Stored procedure: asGLRptBCTCTMVI212
 * Purpose: 			-- Lấy dữ liệu trong bảng người dùng, giữ nguyên mọi giá trị đã lưu
 * 
 * Tham số:
 ...
 *     @pNgay2 => '',
 * ];
 * $result = AsGLRptBCTCTMVI212::call($params);
 * ```
 */
class AsGLRptBCTCTMVI212
{
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asGLRptBCTCTMVI212', [
