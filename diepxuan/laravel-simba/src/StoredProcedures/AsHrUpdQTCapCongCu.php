...
{
    /**
     * Call stored procedure asHrUpdQTCapCongCu
     *
    ...
    /**
     * Call stored procedure asHrUpdQTCapCongCu with named parameters
     *
     * @param string $Ma_cty
     * @param string $Id
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Id = null, string $Id_qtccc = null, string $Ma_nhcc = null, string $Ma_cc = null, string $Ten_cc = null, string $Ngay_cap = null, string $Ngay_tra = null, float $So_luong = null, float $Gia_tri = null, float $Tong_gia_tri = null, string $Ghi_chu = null, string $Luser = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pId' => $Id,
