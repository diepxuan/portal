...
{
    /**
     * Call stored procedure asPOInsCP2
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asPOInsCP2', $params, $connection);
    }

    /**
     * Call stored procedure asPOInsCP2 with named parameters
     *
     * @param string $Ma_cty
