 ...
 *
 * @lastupdate 2026-02-11 13:22:00
 */
 ...
 * Class AsInDelCT1
 * 
 * Stored procedure: asINDelCT1
 * Purpose: Xóa bản ghi trong bảng INCT1 (chi tiết phiếu nhập kho) dựa trên mã công ty và số chứng từ.
 * 
 * Tham số:
...
class AsInDelCT1
{
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asINDelCT1', [
