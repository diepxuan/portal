...
{
    /**
     * Call stored procedure asSORptBK03
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSORptBK03', [
    ...
    /**
     * Call stored procedure asSORptBK03 with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ngay1
     * @param string $Ngay2
