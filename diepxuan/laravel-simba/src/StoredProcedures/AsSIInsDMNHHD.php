...
{
    /**
     * Call stored procedure asSIInsDMNHHD
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSIInsDMNHHD', $params, $connection);
    }

    /**
     * Call stored procedure asSIInsDMNHHD with named parameters
     *
     * @param string $Ma_cty
