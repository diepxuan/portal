 ...
 *
 * @lastupdate 2026-02-11 13:27:00
 */
 ...
 * Class AsInDelCT6M
 * 
 * Stored procedure: asINDelCT6M
 * Purpose: Xóa bản ghi trong bảng INCT6M dựa trên mã công ty và số chứng từ.
 * 
 * Tham số:
 ...
 *     'pStt_rec' => 'CT6M001',
 * ];
 * $result = AsInDelCT6M::call($params);
 * ```
 */
class AsInDelCT6M
{
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asINDelCT6M', [
