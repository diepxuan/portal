 ...
 *
 * @lastupdate 2026-04-06 18:46:48
 */
 ...
 * Class AsCARptTMNH02.
 *
 * Stored procedure: asCARptTMNH02
 * Mục đích: Báo cáo lưu chuyển tiền tệ mẫu 02 (TMNH02).
 ...
 * - @pTk (nvarchar(20)): Tài khoản. Default '112'.
...
{
    /**
     * Gọi stored procedure asCARptTMNH02.
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asCARptTMNH02', [
            'pMa_Cty'   => $paramObj->pMa_Cty ?? SModel::CTY,
            'pTk'       => $paramObj->pTk ?? '112',
    ...
    /**
     * Call stored procedure asCARptTMNH02 with named parameters (helper method).
     *
