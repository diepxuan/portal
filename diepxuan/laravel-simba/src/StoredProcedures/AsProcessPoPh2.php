...
class AsProcessPoPh2
{
    /**
     * Call stored procedure asProcessPoPh2
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessPoPh2', [
    ...
    /**
     * Call stored procedure asProcessPoPh2 with named parameters
     *
     * @param string $Ma_cty
