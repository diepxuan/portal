...
{
    /**
     * Call stored procedure asINInsCT6D
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asINInsCT6D', [
            'pMa_cty' => $paramObj->pMa_cty ?? null,
            'pStt_rec' => $paramObj->pStt_rec ?? null,
            'pStt_rec0' => $paramObj->pStt_rec0 ?? null,
            'pMa_bo' => $paramObj->pMa_bo ?? null,
    ...
    /**
     * Call stored procedure asINInsCT6D with named parameters
     *
     * @param string $Ma_cty
