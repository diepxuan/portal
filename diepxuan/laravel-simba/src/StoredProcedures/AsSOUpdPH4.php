...
{
    /**
     * Call stored procedure asSOUpdPH4
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSOUpdPH4', [
            ...
            'pDia_chi_pn' => $paramObj->pDia_chi_pn ?? null,
            'pNguoi_gd_pn' => $paramObj->pNguoi_gd_pn ?? null,
            'pTel_pn' => $paramObj->pTel_pn ?? null,
            'pDien_giai_pn' => $paramObj->pDien_giai_pn ?? null,
    ...
    /**
     * Call stored procedure asSOUpdPH4 with named parameters
     *
     * @param string $Ma_cty
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Stt_rec = null, string $Ma_ct = null, string $So_seri_mhd = null, string $So_seri = null, string $So_hd = null, string $So_ct = null, string $Ngay_ct = null, string $Ngay_lct = null, string $Ngay_hd = null, string $Ma_kh = null, string $Ten_kh_vat = null, string $Dia_chi_vat = null, string $Ma_so_thue = null, string $Nguoi_gd = null, string $Dien_giai = null, string $Ma_nt = null, float $Ty_gia = null, string $Ma_httt = null, string $Tk_pt = null, string $Tk_thue = null, string $Tk_ck_ds = null, float $Han_ck = null, float $Tl_ck = null, float $Han_tt = null, float $Ls_qh = null, bool $Gia_tb = null, bool $Sua_tien = null, bool $Sua_ck = null, bool $Sua_thue = null, string $So_pn = null, string $Ngay_pn = null, string $Dia_chi_pn = null, string $Nguoi_gd_pn = null, string $Tel_pn = null, string $Dien_giai_pn = null, float $T_tien2 = null, float $T_tien_nt2 = null, float $T_thue = null, float $T_thue_nt = null, bool $kht_tain = null, float $T_ck = null, float $T_ck_nt = null, float $T_ck_ds = null, float $T_ck_ds_nt = null, float $T_tt = null, float $T_tt_nt = null, float $T_so_luong = null, float $T_tien = null, float $T_tien_nt = null, string $Trang_thai = null, string $Post2gl = null, string $Post2in = null, string $LUser = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pStt_rec' => $Stt_rec,
