...
class AsProcessArPh4
{
    /**
     * Call stored procedure asProcessArPh4
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asProcessArPh4', [
    ...
    /**
     * Call stored procedure asProcessArPh4 with named parameters
     *
     * @param string $Ma_cty
