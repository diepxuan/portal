...
class AsHrInsTDYeuCau
{
    /**
     * Call stored procedure asHrInsTDYeuCau
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrInsTDYeuCau', [
            'pMa_cty' => $paramObj->pMa_cty ?? null,
            'pMa_yctd' => $paramObj->pMa_yctd ?? null,
            'pTen_yctd' => $paramObj->pTen_yctd ?? null,
            'pNguoi_yc' => $paramObj->pNguoi_yc ?? null,
            'pNgay_bd' => $paramObj->pNgay_bd ?? null,
            'pNgay_kt' => $paramObj->pNgay_kt ?? null,
            'pHt_nop_hs' => $paramObj->pHt_nop_hs ?? null,
            ...
            'pSo_luong_tuyen' => $paramObj->pSo_luong_tuyen ?? null,
            'pThoi_gian_lv' => $paramObj->pThoi_gian_lv ?? null,
            'pMa_htlv' => $paramObj->pMa_htlv ?? null,
            'pGioi_tinh' => $paramObj->pGioi_tinh ?? null,
            'pTuoi_tu' => $paramObj->pTuoi_tu ?? null,
            'pTuoi_den' => $paramObj->pTuoi_den ?? null,
            'pMuc_chuyen_mon' => $paramObj->pMuc_chuyen_mon ?? null,
            'pMa_chuyen_mon' => $paramObj->pMa_chuyen_mon ?? null,
            'pTen_chuyen_mon' => $paramObj->pTen_chuyen_mon ?? null,
            'pBx_chuyen_mon' => $paramObj->pBx_chuyen_mon ?? null,
            'pMuc_ky_nang' => $paramObj->pMuc_ky_nang ?? null,
            'pMa_ky_nang' => $paramObj->pMa_ky_nang ?? null,
            'pTen_ky_nang' => $paramObj->pTen_ky_nang ?? null,
            'pBx_ky_nang' => $paramObj->pBx_ky_nang ?? null,
            'pMuc_trinh_do' => $paramObj->pMuc_trinh_do ?? null,
            'pMa_trinh_do' => $paramObj->pMa_trinh_do ?? null,
            'pTen_trinh_do' => $paramObj->pTen_trinh_do ?? null,
            'pBx_trinh_do' => $paramObj->pBx_trinh_do ?? null,
            'pMuc_luong' => $paramObj->pMuc_luong ?? null,
            'pQuyen_loi' => $paramObj->pQuyen_loi ?? null,
            'pDs_ho_so' => $paramObj->pDs_ho_so ?? null,
    ...
    /**
     * Call stored procedure asHrInsTDYeuCau with named parameters
     *
     * @param string $Ma_cty
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Ma_yctd = null, string $Ten_yctd = null, string $Nguoi_yc = null, string $Ngay_bd = null, string $Ngay_kt = null, string $Ht_nop_hs = null, string $Ma_dia_diem_lv = null, string $Ten_dia_diem_lv = null, string $Ma_bp = null, string $Ma_cvcm = null, string $Mo_ta = null, float $So_luong_tuyen = null, string $Thoi_gian_lv = null, string $Ma_htlv = null, string $Gioi_tinh = null, float $Tuoi_tu = null, float $Tuoi_den = null, string $Muc_chuyen_mon = null, string $Ma_chuyen_mon = null, string $Ten_chuyen_mon = null, string $Bx_chuyen_mon = null, string $Muc_ky_nang = null, string $Ma_ky_nang = null, string $Ten_ky_nang = null, string $Bx_ky_nang = null, string $Muc_trinh_do = null, string $Ma_trinh_do = null, string $Ten_trinh_do = null, string $Bx_trinh_do = null, string $Muc_luong = null, string $Quyen_loi = null, string $Ds_ho_so = null, string $Ghi_chu = null, string $Trang_thai = null, string $Tai_lieu = null, string $Cuser = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pMa_yctd' => $Ma_yctd,
