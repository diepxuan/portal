...
class AsInsreportDrilldownInfo
{
    /**
     * Call stored procedure asInsreportDrilldownInfo
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asInsreportDrilldownInfo', [
    ...
    /**
     * Call stored procedure asInsreportDrilldownInfo with named parameters
     *
     * @param string $Menuid
     * @param string $Ma_mau
