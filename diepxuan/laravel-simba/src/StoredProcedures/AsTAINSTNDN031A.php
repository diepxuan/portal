...
class AsTAINSTNDN031A
{
    /**
     * Call stored procedure asTAINSTNDN031A
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asTAINSTNDN031A', [
    ...
    /**
     * Call stored procedure asTAINSTNDN031A with named parameters
     *
     * @param string $Ma_cty
     * @param string $mau
     * @param string $ma_so
