...
{
    /**
     * Call stored procedure asHrUpdHSNS
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrUpdHSNS', [
    ...
    /**
     * Call stored procedure asHrUpdHSNS with named parameters
     *
     * @param string $Ma_cty
     * @param string $Id
