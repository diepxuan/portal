...
{
    /**
     * Call stored procedure asPORptBK02
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asPORptBK02', [
    ...
    /**
     * Call stored procedure asPORptBK02 with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ngay1
     * @param string $Ngay2
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Ngay1 = null, string $Ngay2 = null, string $Trang_thai = null, string $Ma_kh = null, string $Ma_nhkh = null, string $Ma_vt = null, string $Ma_nhvt = null, string $Ma_kho = null, string $Ma_bp = null, string $Ma_nt = null, string $Ma_hd = null, string $Soct1 = null, string $Soct2 = null, string $Ma_plkh1 = null, string $Ma_plkh2 = null, string $Ma_plkh3 = null, string $GroupType = null, string $Ma_ct = null, string $Ma_nhhd = null, string $Ma_plvt1 = null, string $Ma_plvt2 = null, string $Ma_plvt3 = null, string $Ma_vitri = null, string $Ma_lo = null, string $Ma_httt = null, string $Ma_TT = null, string $Ma_spct = null, string $Ma_Phi = null, mixed $Ma_phi = null, string $ParamDefines = null, string $Ma_Cty = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pNgay1' => $Ngay1,
