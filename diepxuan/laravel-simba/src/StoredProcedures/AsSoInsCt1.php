...
{
    /**
     * Call stored procedure asSoInsCt1
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asSoInsCt1', [
    ...
    /**
     * Call stored procedure asSoInsCt1 with named parameters
     *
     * @param string $Ma_cty
     ...
     * @return Collection
     */
    public static function callWithParams(string $Ma_cty = null, string $Stt_rec = null, string $Stt_rec0 = null, string $Ma_vt = null, float $So_luong = null, string $Dvt = null, float $So_luong_qd = null, float $Gia_nt2 = null, float $Gia2 = null, float $Tien_nt2 = null, float $Tien2 = null, float $Tl_ck = null, float $Tien_ck_nt = null, float $Tien_ck = null, float $Ck_ds = null, float $Ck_ds_nt = null, string $Ma_thue = null, float $Ts_gtgt = null, float $Thue_gtgt_nt = null, float $Thue_gtgt = null, float $Tt_nt = null, float $Tt = null, bool $Khuyen_mai = null, bool $Tra_ck = null, string $Tk_pt = null, string $Tk_dt = null, string $Tk_gv = null, string $Tk_vt = null, string $Tk_thue = null, string $Tk_ck = null, string $Ten_vt = null, string $Ma_kho = null, string $Ma_vitri = null, string $Ma_lo = null, string $Ma_bp = null, string $Ma_hd = null, string $Ma_phi = null, string $Ma_spct = null, string $Ma_nvkd = null, int $Ret = null): Collection
    {
        $params = [
            'pMa_cty' => $Ma_cty,
            'pStt_rec' => $Stt_rec,
