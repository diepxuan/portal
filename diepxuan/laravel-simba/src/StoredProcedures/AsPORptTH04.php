...
{
    /**
     * Call stored procedure asPORptTH04
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asPORptTH04', [
    ...
    /**
     * Call stored procedure asPORptTH04 with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ngay1
     * @param string $Ngay2
