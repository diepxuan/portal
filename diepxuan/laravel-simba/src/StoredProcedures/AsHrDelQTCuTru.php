...
class AsHrDelQTCuTru
{
    /**
     * Call stored procedure asHrDelQTCuTru
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asHrDelQTCuTru', [
    ...
    /**
     * Call stored procedure asHrDelQTCuTru with named parameters
     *
     * @param string $Ma_cty
     * @param string $Id
