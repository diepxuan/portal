...
{
    /**
     * Call stored procedure asPORptTH01
     *
    ...
    public static function call(array $params): Collection
    {
        ...
        return ProcedureCaller::call('asPORptTH01', [
    ...
    /**
     * Call stored procedure asPORptTH01 with named parameters
     *
     * @param string $Ma_cty
     * @param string $Ngay1
     * @param string $Ngay2
