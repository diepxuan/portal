 ...
 *
 * @lastupdate 2026-04-06 08:15:17
 */
 ...
 * - @pStt_rec (nvarchar(20)): Số thứ tự record (stt_rec). Khóa chính của bảng CACT1. Bắt buộc.
 ...
 *
 * @see AsCAGetCT1::call() - Kiểm tra chứng từ tồn tại trước khi xóa
 */
class AsCADelCT1
{
    /**
    ...
    /**
     * Call stored procedure asCADelCT1 with named parameters (helper method).
     *
