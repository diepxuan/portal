 ...
 *
 * @lastupdate 2026-05-05 20:11:14
 */
...
use Diepxuan\Catalog\Http\Livewire\Banhang\KhachhangList;
...
Route::middleware(['auth'])->group(static function (): void {
    ...
    Route::get('/banhang/khachhang', KhachhangList::class)->name('ar.khachhang');
