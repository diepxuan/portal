...
Route::middleware([CorpAutoLogin::class])->group(static function (): void {
    Route::redirect('/gl/taikhoan', '/_simba-source/gl/dict/gldmtk')->name('gl.taikhoan');
    Route::redirect('/cash/tienmat/thu', '/_simba-source/ca/vch/cavchca1')->name('ca.tienmat.thu');
    Route::redirect('/cash/tienmat/chi', '/_simba-source/ca/vch/cavchca2')->name('ca.tienmat.chi');
    Route::redirect('/cash/tienmat/quy', '/_simba-source/ca/rpt/carpttmnh01')->name('ca.tienmat.quy');
    Route::redirect('/cash/nganhang/baoco', '/_simba-source/ca/vch/cavchca4')->name('ca.nganhang.baoco');
    Route::redirect('/cash/nganhang/baono', '/_simba-source/ca/vch/cavchca5')->name('ca.nganhang.baono');
    Route::redirect('/cash/nganhang/quy', '/_simba-source/ca/rpt/carpttmnh02')->name('ca.nganhang.quy');
    Route::redirect('/cash/thu', '/_simba-source/ca/rpt/carpttmnh01')->name('ca.thu');
    Route::redirect('/cash/chi', '/_simba-source/ca/rpt/carpttmnh02')->name('ca.chi');
    Route::redirect('/cash/quy', '/_simba-source/ca/rpt/carpttmnh01')->name('ca.quy');
    Route::redirect('/cash/nhanvien', '/_simba-source/ca/dict/ardmkh')->name('ca.nhanvien');
    ...
    Route::redirect('/banhang/hoadonbanhang', '/_simba-source/so/vch/sovchso1')->name('ar.ph.hdbh');
    Route::resource('banhang/bangkebanhang', SellController::class)->names('sell.list');
    Route::redirect('/co/danhmuc/dinh-muc-bom', '/_simba-source/co/dict/codmbom')->name('co.dmbom');
    Route::redirect('/co/danhmuc/dinh-muc-chi-tiet', '/_simba-source/co/dict/codmbomct')->name('co.dinhmucchitiet');

    Route::redirect('/muahang/cungcap', '/_simba-source/ar/dict/ardmkh')->name('ar.cungcap');
    Route::redirect('/muahang/nhacungcap', '/_simba-source/po/dict/ardmkh')->name('po.cungcap');
    ...
    Route::redirect('/muahang/chiphimuahang/danhmuc', '/_simba-source/po/dict/podmcp')->name('po.dmcp');
    ...
    Route::prefix('_simba-source')->group(static function (): void {
        $sourceRoutes = [
            ['uri' => 'ca/dict/ardmkh', 'name' => 'ca.dict.ardmkh', 'module' => 'ca', 'kind' => 'dict', 'slug' => 'ardmkh', 'component' => \Diepxuan\Catalog\Http\Livewire\Cash\Danhmuc\Nhanvien::class],
            ...
            ['uri' => 'ca/vch/cavchca1', 'name' => 'ca.vch.cavchca1', 'module' => 'ca', 'kind' => 'vch', 'slug' => 'cavchca1', 'component' => \Diepxuan\Catalog\Http\Livewire\Cash\Tienmat\Phieuthu::class],
            ['uri' => 'ca/vch/cavchca2', 'name' => 'ca.vch.cavchca2', 'module' => 'ca', 'kind' => 'vch', 'slug' => 'cavchca2', 'component' => \Diepxuan\Catalog\Http\Livewire\Cash\Tienmat\Phieuchi::class],
            ['uri' => 'ca/vch/cavchca3', 'name' => 'ca.vch.cavchca3', 'module' => 'ca', 'kind' => 'vch', 'slug' => 'cavchca3', 'component' => SimbaPage::class],
            ['uri' => 'ca/vch/cavchca4', 'name' => 'ca.vch.cavchca4', 'module' => 'ca', 'kind' => 'vch', 'slug' => 'cavchca4', 'component' => \Diepxuan\Catalog\Http\Livewire\Cash\Nganhang\Baoco::class],
            ...
            ['uri' => 'gl/dict/gldmtk', 'name' => 'gl.dict.gldmtk', 'module' => 'gl', 'kind' => 'dict', 'slug' => 'gldmtk', 'component' => \Diepxuan\Catalog\Http\Livewire\Gl\Taikhoan::class],
            ...
            ['uri' => 'in/dict/indmkho', 'name' => 'in.dict.indmkho', 'module' => 'in', 'kind' => 'dict', 'slug' => 'indmkho', 'component' => \Diepxuan\Catalog\Http\Livewire\In\Dmkho::class],
            ['uri' => 'in/dict/indmlo', 'name' => 'in.dict.indmlo', 'module' => 'in', 'kind' => 'dict', 'slug' => 'indmlo', 'component' => SimbaPage::class],
            ['uri' => 'in/dict/indmnhvt', 'name' => 'in.dict.indmnhvt', 'module' => 'in', 'kind' => 'dict', 'slug' => 'indmnhvt', 'component' => \Diepxuan\Catalog\Http\Livewire\In\Dmnhvt::class],
            ['uri' => 'in/dict/indmvt', 'name' => 'in.dict.indmvt', 'module' => 'in', 'kind' => 'dict', 'slug' => 'indmvt', 'component' => \Diepxuan\Catalog\Http\Livewire\In\Dmvt::class],
            ...
            ['uri' => 'po/dict/ardmkh', 'name' => 'po.dict.ardmkh', 'module' => 'po', 'kind' => 'dict', 'slug' => 'ardmkh', 'component' => \Diepxuan\Catalog\Http\Livewire\Muahang\Cungcap::class],
            ['uri' => 'po/dict/ardmplkh', 'name' => 'po.dict.ardmplkh', 'module' => 'po', 'kind' => 'dict', 'slug' => 'ardmplkh', 'component' => SimbaPage::class],
            ['uri' => 'po/dict/podmcp', 'name' => 'po.dict.podmcp', 'module' => 'po', 'kind' => 'dict', 'slug' => 'podmcp', 'component' => \Diepxuan\Catalog\Http\Livewire\Muahang\PoDmCpIndex::class],
            ...
            ['uri' => 'so/dict/ardmkh', 'name' => 'so.dict.ardmkh', 'module' => 'so', 'kind' => 'dict', 'slug' => 'ardmkh', 'component' => \Diepxuan\Catalog\Http\Livewire\Banhang\Khachhang::class],
            ['uri' => 'so/dict/ardmplkh', 'name' => 'so.dict.ardmplkh', 'module' => 'so', 'kind' => 'dict', 'slug' => 'ardmplkh', 'component' => \Diepxuan\Catalog\Http\Livewire\AR\Danhmuc\Phanloaikhachhang::class],
            ...
            ['uri' => 'so/rpt/arrptbccn01', 'name' => 'so.rpt.arrptbccn01', 'module' => 'so', 'kind' => 'rpt', 'slug' => 'arrptbccn01', 'component' => SimbaPage::class],
            ...
            ['uri' => 'so/vch/sovchso1', 'name' => 'so.vch.sovchso1', 'module' => 'so', 'kind' => 'vch', 'slug' => 'sovchso1', 'component' => \Diepxuan\Catalog\Http\Livewire\Banhang\Hoadonbanhang::class],
