...
/**
 * Form Sửa/Thêm vật tư.
 *
 * Tách riêng để khi người dùng gõ vào một field, chỉ component này
 ...
 *  - `indmvt-form.cancelled` khi người dùng đóng form
 */
class IndmvtForm extends Component
{
    ...
    public function cancelForm(): void
    {
        ...
        $this->dispatch('indmvt-form.cancelled');
    }
    ...
    public function closeWhenDeleted(string $maVt): void
    {
        if ((string) ($this->form['ma_vt'] ?? '') !== $maVt) {
            return;
        }
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->showForm = false;
            $this->dispatch('indmvt-form.saved', maVt: (string) $this->form['ma_vt']);
    ...
    public function fillBomItem(int $index): void
    {
        ...
        $item = '' === $maLk ? null : $this->fetchRowForEdit($maLk);
        if (null === $item) {
            return;
        }
    ...
    {
        return view('catalog::in.dict.indmvt-form');
    }
