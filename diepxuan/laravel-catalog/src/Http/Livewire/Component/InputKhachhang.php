 ...
 * - Multi-mode: khachhang,nhacungcap (isKh = true OR isNcc = true)
 *
 * Lưu ý: Tất cả mode đều dùng OR logic (không hỗ trợ AND)
 *
 * Usage:
 ...
 * <livewire:catalog::component.input-khachhang mode="khachhang,nhacungcap" wire:model="pMa_KhachHoacNcc" />
...
class InputKhachhang extends Component
{
    ...
    public function updatedSearch(): void
    {
        ...
        // Build query theo mode (OR logic - mặc định)
        // Mode: khachhang,nhacungcap,nhanvien (isKh = true OR isNcc = true OR isNv = true)
        $query = ArDmKh::query();

        // Parse mode (comma-separated, OR logic)
