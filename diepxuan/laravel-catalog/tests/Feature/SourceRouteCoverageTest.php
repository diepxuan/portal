...
final class SourceRouteCoverageTest extends TestCase
{
    ...
    private function componentBackedSourceRoutes(): array
    {
        return [
            ...
            ['module' => 'in', 'kind' => 'dict', 'slug' => 'indmvt', 'routeName' => 'in.dict.indmvt', 'url' => '/_simba-source/in/dict/indmvt', 'component' => \Diepxuan\Catalog\Http\Livewire\In\Dict\Indmvt::class],
