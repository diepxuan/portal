        ...
        <tbody>
            @forelse ($pChiTiet ?? [] as $i => $row)
                <tr wire:key="so3-ct-{{ $i }}" class="border-b">
                    ...
                    <td class="px-1 py-1"><input wire:model="pChiTiet.{{ $i }}.tien_nt2" class="w-28 rounded border border-gray-200 bg-gray-50 px-2 py-1 text-right text-xs" readonly /></td>
                    ...
                    <td class="px-1 py-1"><input wire:model="pChiTiet.{{ $i }}.tien_ck_nt" class="w-24 rounded border border-gray-200 bg-gray-50 px-2 py-1 text-right text-xs" readonly /></td>
