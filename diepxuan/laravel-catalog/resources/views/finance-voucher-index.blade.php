<div class="finance-voucher-container w-full">
    <x-head-title>{{ $metadata['title'] }}</x-head-title>
    ...
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-600">
                {{ $voucherCode }} - {{ $metadata['ph'] ?: $metadata['table_ph'] }}/{{ $metadata['ct'] ?: $metadata['table_ct'] }} - menu {{ $metadata['menuid'] }}
            </p>
        </div>
    </x-slot>
