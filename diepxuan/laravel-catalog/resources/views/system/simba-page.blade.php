<div>
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between border-b border-gray-200 pb-3">
            ...
            @if ($target)
                <span
                    class="rounded bg-blue-50 px-2 py-1 font-mono text-xs text-blue-700 ring-1 ring-inset ring-blue-200">
            ...
            <section class="min-w-0 flex-1 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                @if (!$target)
                    <div class="flex min-h-[420px] flex-col items-center justify-center text-center text-gray-500">
                        ...
                        <p class="mt-2 text-sm">Sử dụng menu bên trái để mở chức năng theo URL chuẩn
                            /simba/&lt;module&gt;/&lt;type&gt;/&lt;code&gt;.</p>
                    </div>
