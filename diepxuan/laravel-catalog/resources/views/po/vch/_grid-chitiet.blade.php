<div class="space-y-2">
    <table class="min-w-max w-full text-xs">
        <thead class="bg-gray-50 border-b">
            <tr>
                <th class="px-2 py-1 text-left font-medium text-gray-600">Ma VT</th>
                <th class="px-2 py-1 text-left font-medium text-gray-600">Ten VT</th>
                <th class="px-2 py-1 text-left font-medium text-gray-600">DVT</th>
                <th class="px-2 py-1 text-left font-medium text-gray-600">Ma kho</th>
                <th class="px-2 py-1 text-right font-medium text-gray-600">So luong</th>
                <th class="px-2 py-1 text-right font-medium text-gray-600">Don gia NT</th>
                <th class="px-2 py-1 text-right font-medium text-gray-600">Thanh tien NT</th>
                ...
                <th class="px-2 py-1 text-right font-medium text-gray-600">Chi phi NT</th>
            ...
            @forelse ($pChiTiet ?? [] as $i => $row)
                <tr wire:key="ct-{{ $i }}" class="border-b">
                    ...
                    <td class="px-1 py-1 text-center">
                        <button type="button" wire:click="removeChiTietRow({{ $i }})" class="rounded border border-red-200 px-2 py-1 text-xs text-red-600 hover:bg-red-50">Xoa</button>
                    </td>
                </tr>
            @empty
                <tr><td colspan="13" class="px-2 py-3 text-center text-xs text-gray-500">Chua co dong chi tiet</td></tr>
            @endforelse
        </tbody>
    </table>
    <div class="flex justify-end gap-2 pt-2">
        <button type="button" wire:click="addChiTietRow" class="rounded border border-gray-300 px-3 py-1 text-xs text-gray-700 hover:bg-gray-50">+ Them dong</button>
    </div>
</div>
